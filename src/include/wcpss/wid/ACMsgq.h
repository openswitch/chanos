...
typedef enum{
	...
	WTP_FLOW_CHECK = 20,
	WTP_SET_NAME_PASSWD = 21,
	WTP_MULTI_USER_OPTIMIZE = 22,
	WTP_STA_DEAUTH_SWITCH = 23,
	WTP_STA_FLOW_INFORMATION_SWITCH = 24,
	WTP_STA_ACL_SWITCH = 25,
	WTP_STA_ACL_LIST = 26,
	WTP_SET_AP_5G_FIRST = 27,
	WTP_QOS_MAP_INFO = 28,
	WTP_QOS_MAP_SWITCH = 29,
	WTP_SPECTRUM_ANALYSIS = 30,
	WTP_LAN_VLAN = 31,			/* ENR-23 */
	WTP_BLACK_WHITE_LIST = 32,
	WTP_ELECTRONIC_MENU = 33,
	WLAN_LOAD_BALANCE = 34,
	WTP_OP_INVALID = 35
}WtpOP;
...
typedef enum{
	...
	RADIO_WSM_STA_INFO_REPORT = 19, /*fengwenchao add 20120414*/
