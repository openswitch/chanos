...
enum npd_dbus_result_no_e {
	...
	NPD_DBUS_ERROR_DISENABLE_PLATFORM /* add by zhangjw*/
};
...
/*****************************************************************************************
 * DESCRIPTION:
 *	This method show cascade device power supply info		
 *
 * INPUT:
 *	NONE
 *
 * OUTPUT:
 * 	uint32 - ps_no // unsigned int of power supply unit number.
 *	uint32 - inserted // power supply inserted state
 * 	string - ps_type  // power supply type
 *
 *****************************************************************************************/
#define NPD_DBUS_DEVICE_OBJPATH "/aw/npd/device"
#define NPD_DBUS_DEVICE_INTERFACE "aw.npd.device"

#define NPD_DBUS_DEVICE_SHOW_POWER_SUPPLY		"show_dev_power"

#define NPD_DBUS_DEVICE_NEXT_PSUNIT			"dev_next_psunit"

#define NPD_DBUS_DEVICE_SHOW_FAN			"show_dev_fan"

#define NPD_DBUS_DEVICE_NEXT_FAN			"dev_next_fan"

#define NPD_DBUS_DEVICE_CONFIG_FANSPEED			"show_config_fanspeed"



/*****************************************************************************************
 * DESCRIPTION:
 * 	This method show the runstate of local board
 *
 * INPUT:
 *	NONE
 *
 ...
 *	byte total_slot_count // total slot count to show out
 *	Array of slot information
 *		string -state_str // runstate of current board
 *
 *****************************************************************************************/

#define NPD_DBUS_BOARDMNG_OBJPATH "/aw/npd/boardmng"
#define NPD_DBUS_BOARDMNG_INTERFACE "aw.npd.boardmng"

#define	NPD_DBUS_BOARDMNG_SHOW_SLOT_ATTR	"show_slot_attr"

#define NPD_DBUS_BOARDMNG_NEXT_SLOT			"get_next_slot"

#define NPD_DBUS_BOARDMNG_CONFIG_SLOT_TYPE	"config_slot_type"

#define NPD_DBUS_BOARDMNG_NO_CONFIG_SLOT	"no_config_slot"

#define NPD_DBUS_BOARDMNG_SHOW_RUN          "boardmng_show_run"

#define NPD_DBUS_BOARDMNG_BOARD_RANGE		"board_range"

#define NPD_DBUS_BOARDMNG_BOARD_SWITCHOVER  "board_switchover"

#define NPD_DBUS_BOARDMNG_BOARD_ISSTANDBY   "board_isstandby"

#define NPD_DBUS_BOARDMNG_BOARD_REBOOT       "board_reboot"

#define NPD_DBUS_BOARDMNG_BOARD_CONFIG  "board_config"
...
/************************************************************************
 * DESCRIPTION:
 * 	arg lists for method NPD_DBUS_INTF_METHOD_CREATE_INTF
 *
 * INPUT:
 *		uint32   - netif index    // l2 netif index
 *
 * OUTPUT:
 *
 *		uint32 - op_ret     
 ...
 *
 ***********************************************************************/
#define NPD_DBUS_INTF_METHOD_CREATE_INTF "create_one_intf"
/************************************************************************
 * DESCRIPTION:
 * 	arg lists for method NPD_DBUS_INTF_METHOD_DELETE_INTF
 *
 * INPUT:
 *		uint32   - netif index    // l2 netif index
 *
 ...
 *
 *		uint32 - op_ret     
 *						NPD_DBUS_SUCCESS - successfully delete l3 intf
 *						NPD_VLAN_BADPARAM - vid error
 *						NPD_VLAN_NOTEXISTS - vlan don't exist
 *						L3_INTF_EXIST - L3 interface has exsted
 *						NPD_DBUS_ERROR - failed create l3 intf
 ...
 *
 ***********************************************************************/
#define NPD_DBUS_INTF_METHOD_DELETE_INTF "delete_one_intf"
/************************************************************************
 * DESCRIPTION:
...
/************************************************************************
 * DESCRIPTION:
 * 	arg lists for method NPD_DBUS_INTF_METHOD_SHUTDOWN_SET
 *
 * INPUT:
 *		netif_index      // netif index to shutdown
 *
 * OUTPUT:
 *		
 *		uint32 - op_ret     
 *						NPD_DBUS_SUCCESS - successfully shutdown l3 intf 
 *						NPD_DBUS_ERROR -     failed to shutdown l3 intf
 *
 ***********************************************************************/
#define NPD_DBUS_INTF_METHOD_SHUTDOWN_SET "shutdown_set"

#ifndef HAVE_ZEBRA 
#define NPD_DBUS_INTF_METHOD_ADD_IPV4_ADDR "add_ipv4_addr"
#define NPD_DBUS_INTF_METHOD_DEL_IPV4_ADDR "del_ipv4_addr"
#define NPD_DBUS_INTF_METHOD_INTF_SHOW_RUN "intf_show_run"
#endif
#ifdef HAVE_PORTAL 
#define NPD_DBUS_INTF_SET_PORTAL_SERVER        "set_portal_server"
#define NPD_DBUS_INTF_SHOW_PORTAL_INTERFACE    "show_portal_interface"
#define NPD_DBUS_INTF_PORTAL_SHOW_RUN          "portal_server_showrunning"
#endif
#define NPD_DBUS_INTF_METHOD_BIND_SET     "ipsourcebind_set"
/************************************************************************
 * DESCRIPTION:
 * 	arg lists for method NPD_DBUS_INTF_METHOD_VLAN_INTF_CHECK
 *
 * INPUT:
 *		uint16   - vid    // vlan id
 *
 ...
 *		
 *		uint32 - op_ret     
 *						NPD_DBUS_SUCCESS - vlan intf exists
 *						NPD_DBUS_ERROR -     vlan_intf doesn't exists
 *
 ***********************************************************************/
#define NPD_DBUS_INTF_METHOD_VLAN_INTF_CHECK "vlan_intf_check"

/************************************************************************
 * DESCRIPTION:
 * 	arg lists for method NPD_DBUS_INTF_METHOD_INTF_PROXY_ARP_SET
 *
 * INPUT:
 *		uint32   - ifname    // l3 interface netif index
 *          uint8     - proxyarp //l3 interface proxy arp 
 *
 * OUTPUT:
 *		
 *		uint32 - op_ret     
 *						NPD_DBUS_SUCCESS - intf exists
 *						NPD_DBUS_ERROR -     intf doesn't exists
 *
 ***********************************************************************/
#define NPD_DBUS_INTF_METHOD_INTF_PROXY_ARP_SET "l3intf_proxy_arp_set"

/************************************************************************
 * DESCRIPTION:
 * 	arg lists for method NPD_DBUS_INTF_METHOD_INTF_URPF_SET
 *
 * INPUT:
 *		uint32   - ifname    // l3 interface netif index
 *          uint32     - urpf enable or disable //l3 interface urpf checking 
 *
 * OUTPUT:
 *		
 *		uint32 - op_ret     
 ...
 *
 ***********************************************************************/
#define NPD_DBUS_INTF_METHOD_INTF_URPF_SET "l3intf_urpf_set"
#define NPD_DBUS_INTF_METHOD_CONF_URPF_SET "config_urpf_set"
#define NPD_DBUS_INTF_METHOD_CONF_URPF_GET "config_urpf_get"

#define NPD_DBUS_INTF_METHOD_CONF_IPMC_SET     "config_ipmc_set"
#define NPD_DBUS_INTF_METHOD_CONF_IPMC_GET     "config_ipmc_get"
/************************************************************************
 * DESCRIPTION:
 * 	arg lists for method NPD_DBUS_INTF_METHOD_L3INTF_GET_NEXT
 *
 * INPUT:
 *		uint32   - netif_index    // l3 interface netif index
 *
 * OUTPUT:
 *		
 *		uint32 - op_ret     
 ...
 *
 ***********************************************************************/
#define NPD_DBUS_INTF_METHOD_L3INTF_GET_NEXT "l3intf_get_next"

/************************************************************************
 * DESCRIPTION:
 * 	arg lists for method NPD_DBUS_INTF_METHOD_L3INTF_GET
 *
 * INPUT:
 *		uint32   - netif_index    // l3 interface netif index
 *
 ...
 *
 ***********************************************************************/
#define NPD_DBUS_INTF_METHOD_L3INTF_GET "l3intf_get"
...
#define NPD_DBUS_INTERFACE_SOUCE_GUARD_SERVICE  "ip_sg_service"
#define NPD_DBUS_INTERFACE_SOUCE_GUARD_ENTRY    "ip_sg_entry"
#define NPD_DBUS_INTERFACE_SOUCE_GUARD_SHOW_PORT "ip_sg_show_port"
#define NPD_DBUS_INTERFACE_SOUCE_GUARD_SHOW_ALL "ip_sg_show_all"
#define NPD_DBUS_INTERFACE_SOUCE_GUARD_SHOWRUNNING  "ip_sg_showrunning"

#ifdef HAVE_NPD_IPV6
/************************************************************************
 * DESCRIPTION:
 * 	arg lists for method NPD_DBUS_INTERFACE_IPV6_STATIC_NEIGH
 *
 * INPUT:
 *		PORTNO - SLOTNO/PORTNO
 *           MAC      -  MAC Address,AS H:H:H:H:H:H
 *           IP         -  IPV6 Address, AS X:X::X:X
 *           VID       -  1-4094
 * 	
 *
 * OUTPUT:
 *		
 *		uint32 - op_ret     
 *						NPD_DBUS_SUCCESS - successfully create static neighbour 
 *						NPD_DBUS_ERROR_NO_SUCH_PORT - slot/port  error
 *
 ***********************************************************************/
#define NPD_DBUS_INTERFACE_IPV6_STATIC_NEIGH "ipv6_static_neigh"


/************************************************************************
 * DESCRIPTION:
 * 	arg lists for method NPD_DBUS_INTERFACE_IP_STATIC_NEIGH_FOR_TRUNK
 *
 * INPUT:
 *		TRUNKID - 1-127
 *           MAC      -  MAC Address,AS H:H:H:H:H:H
 *           IP         -  IP Address, AS X:X::X:X/M
 *           VID       -  1-4094
 * 	
 *
 * OUTPUT:
 ...
 *
 ***********************************************************************/
#define NPD_DBUS_INTERFACE_IP_STATIC_NEIGH_FOR_TRUNK "ip_static_neighbour_for_trunk"

/************************************************************************
 * DESCRIPTION:
 * 	arg lists for method NPD_DBUS_INTERFACE_NO_IP_STATIC_NEIGHBOUR
 *
 * INPUT:
 *		PORTNO - SLOTNO/PORTNO
 *           MAC      -  MAC Address,AS H:H:H:H:H:H
 *           IP         -  IPv6 Address, AS X:X::X:X/M
 *           VID       -  1-4094
 * 	
 *
 * OUTPUT:
 ...
 *
 ***********************************************************************/
#define NPD_DBUS_INTERFACE_NO_IP_STATIC_NEIGH "no_ip_static_neighour"
...
/************************************************************************
 * DESCRIPTION:
 * 	arg lists for method NPD_DBUS_INTF_METHOD_SHOW_NEIGH_SPECIFY
 *
 * INPUT:
 *          flag  -- search mode
 * 		 IFINDEX -- port index or trunk index
 *		 VID       -  1-4094
 *		 IP         -  IPv6 Address, AS X:X::X:X/M
 *		 MAC      -  MAC Address,AS H:H:H:H:H:H
 * 		
...
#define NPD_DBUS_INTF_METHOD_SHOW_NEIGH_SPECIFY "show_ip_neigh_info"



/************************************************************************
 * DESCRIPTION:
 * 	arg lists for method NPD_DBUS_INTF_METHOD_CLEAR_ARP_FOR_IFINDEX
 *
 * INPUT:
 * 		 IFINDEX -- port index or trunk index
 *		 isStatic  -- only static or both
 * 		
 *
 * OUTPUT:
 *		
...
#define NPD_DBUS_INTF_METHOD_CLEAR_NEIGHBOUR_FOR_IFINDEX "clear_ipv6_neigh_for_ifindex"

/************************************************************************
 * DESCRIPTION:
 * 	arg lists for method NPD_DBUS_INTF_NEIGH_METHOD_SHOW_RUNNING_CONFIG
 *
 * INPUT:
 * 		 
 * 		
 ...
 *
 ***********************************************************************/
#define NPD_DBUS_INTF_NEIGH_METHOD_SHOW_RUNNING_CONFIG "show_static_neigh_running_config"

#define NPD_DBUS_INTF_METHOD_SET_NDP_AGETIME "set_ip_ndp_agetime"

#define NPD_DBUS_INTF_METHOD_SHOW_NDP_AGETIME "show_ip_ndp_agetime"
...
/************************************************************************
 * DESCRIPTION:
 * 	arg lists for method NPD_DBUS_INTF_DYNTOSTATIC_ARP
 *
 * INPUT:
 *		
 *          
 ...
 *
 ***********************************************************************/
#define NPD_DBUS_INTF_DYNTOSTATIC_ARP "dyntostatic_arp"
 ...
 *
 ***********************************************************************/
#define NPD_DBUS_INTF_DYNTOSTATIC_ARP_FOR_TRUNK "dyntostatic_arp_for_trunk"

/************************************************************************
 * DESCRIPTION:
 * 	arg lists for method NPD_DBUS_INTF_METHOD_SHOW_ARP_SPECIFY
 *
 * INPUT:
 *          flag  -- search mode
 * 		 IFINDEX -- port index or trunk index
...
#define NPD_DBUS_INTF_METHOD_SHOW_ARP_SPECIFY "show_ip_arp_info"
...
#define NPD_DBUS_INTF_METHOD_CLEAR_ARP_FOR_IFINDEX "clear_ip_arp_for_ifindex"
...
#define NPD_DBUS_INTF_METHOD_SET_ARP_AGETIME "set_ip_arp_agetime"

#define NPD_DBUS_INTF_METHOD_SET_ARP_DROP "set_ip_arp_drop"

/************************************************************************
 * DESCRIPTION:
 * 	show arg age time for method NPD_DBUS_INTF_METHOD_SHOW_ARP_AGETIME
 *
 * INPUT:
 * 		 
 *		 
...
#define NPD_DBUS_INTF_METHOD_SHOW_ARP_AGETIME "show_ip_arp_agetime"

#define NPD_DBUS_INTF_METHOD_SHOW_ARP_DROP "show_ip_arp_drop"
...
#define NPD_DBUS_ARP_INSPECTION_METHOD_SHOW_RUNNING_CONFIG "show_running_arp_inspection"

#define NPD_DBUS_INTF_PROXY_ARP_METHOD_SHOW_RUNNING_CONFIG "show_running_intf_proxy_arp"

#define NPD_DBUS_CONFIG_VLAN_ARP_INSPECTION "CONFIG_VLAN_ARP_INSPECTION"

#define NPD_DBUS_URPF_METHOD_SHOW_RUNNING_CONFIG "show_running_urpf"
...
#define NPD_DBUS_MLDSNP_OBJPATH     "/aw/npd/mldsnp"
#define NPD_DBUS_MLDSNP_INTERFACE   "aw.npd.mldsnp"

#define NPD_DBUS_MLDSNP_METHOD_SET_VLAN_ENABLE	"mld_snp_set_vlan_enable"


#define NPD_DBUS_IGMPSNP_OBJPATH     "/aw/npd/igmpsnp"
#define NPD_DBUS_IGMPSNP_INTERFACE   "aw.npd.igmpsnp"

/*****************************************************************
 * DESCRIPTION:
 * 	arg lists for method NPD_DBUS_IGMPSNP_METHOD_CHECK_VLAN_IGMP_SNP_STATUS 
 *
 * INPUT:
...
*****************************************************************/
#define NPD_DBUS_IGMPSNP_METHOD_CHECK_VLAN_IGMP_SNP_STATUS	"igmp_vlan_state"


/*****************************************************************
 * DESCRIPTION:
 * 	arg lists for method NPD_DBUS_IGMPSNP_METHOD_CHECK_IGMP_SNP_VLANMBR_STATUS 
 *
 * INPUT:
 ...
 *
*****************************************************************/
#define NPD_DBUS_IGMPSNP_METHOD_CHECK_IGMP_SNP_VLANMBR_STATUS  "check_igmpport_status"

/*****************************************************************
 * DESCRIPTION:
 * 	arg lists for method NPD_DBUS_IGMPSNP_METHOD_IGMP_SNP_VLAN_COUNT 
 *
 * INPUT:
 *		NONE
 *
 ...
 *		
*****************************************************************/
#define NPD_DBUS_IGMPSNP_METHOD_IGMP_SNP_VLAN_COUNT	"igmp_vlan_count_show"

/*****************************************************************
 * DESCRIPTION:
 * 	arg lists for method NPD_DBUS_IGMPSNP_METHOD_CONFIG_IGMP_SNP_VLAN
 *
 * INPUT:
 *
 *		NONE
 ...
 *		
*****************************************************************/
#define NPD_DBUS_IGMPSNP_METHOD_CONFIG_IGMP_SNP_VLAN	"config_igmp_vlan"

/*****************************************************************
 * DESCRIPTION:
 * 	arg lists for method NPD_DBUS_IGMPSNP_METHOD_IGMP_SNP_VLAN_LIST_SHOW 
 *
 * INPUT:
 *		NONE
 *
...
*****************************************************************/
#define NPD_DBUS_IGMPSNP_METHOD_IGMP_SNP_VLAN_LIST_SHOW "vlan_port_igmp_info_show"

/*****************************************************************
 * DESCRIPTION:
 * 	arg lists for method NPD_DBUS_IGMPSNP_METHOD_CONFIG_ETHPORT
 *
 * INPUT:
 *
 *		NONE
 ...
 *		
*****************************************************************/
#define NPD_DBUS_IGMPSNP_METHOD_CONFIG_ETHPORT	"config_igmp_eth_port"

#if 0
/*****************************************************************
 * DESCRIPTION:
 * 	arg lists for method NPD_DBUS_IGMPSNP_METHOD_ADD_DEL_MCROUTE_PORT
 *
 * INPUT:
 ...
 *		
*****************************************************************/
#define NPD_DBUS_IGMPSNP_METHOD_ADD_DEL_MCROUTE_PORT	"add_del_mcroute_port"

/*****************************************************************
 * DESCRIPTION:
 * 	arg lists for method NPD_DBUS_IGMPSNP_METHOD_SHOW_MCGROUP_LIST_PORT_MEMBERS
 *
 * INPUT:
 *
 *		NONE
 ...
 *		
*****************************************************************/
#define NPD_DBUS_IGMPSNP_METHOD_SHOW_MCGROUP_LIST_PORT_MEMBERS	"show_group_list_mbr"

/*****************************************************************
 * DESCRIPTION:
 * 	arg lists for method NPD_DBUS_IGMPSNP_METHOD_SHOW_MCGROUP_LIST_PORT_COUNT
 *
 * INPUT:
 *
 *		NONE
 ...
 *		
*****************************************************************/
#define NPD_DBUS_IGMPSNP_METHOD_SHOW_MCGROUP_LIST_COUNT	"show_group_list_count"

/*****************************************************************
 * DESCRIPTION:
 * 	arg lists for method NPD_DBUS_IGMPSNP_METHOD_SHOW_MCGROUP_TOTAL_COUNT
 *
 * INPUT:
 *
 *		NONE
 ...
 *		
*****************************************************************/
#define NPD_DBUS_IGMPSNP_METHOD_SHOW_MCGROUP_TOTAL_COUNT	"show_group_total_count"
#endif
/*****************************************************************************
*	DESCRIPTION: 
*	arg lists for method NPD_DBUS_IGMPSNP_METHOD_SHOW_VLAN_RUNNING_CONFIG
*
*	INPUT:
*		NONE;
...
*
********************************************************************************/
#define NPD_DBUS_IGMPSNP_METHOD_SHOW_VLAN_RUNNING_CONFIG "show_igmp_snp_vlan_running"
...
#define NPD_DBUS_VLAN_METHOD_UPDATE_NAME                        "config_vlan_update_name"
/*****************************************************************************************
 * DESCRIPTION:
...
#define NPD_DBUS_VLAN_METHOD_CONFIG_PROT_PORT_APPLY		"port_apply_prot_vlan"

#define NPD_DBUS_VLAN_METHOD_CONFIG_SHOW_SUPERVLAN_ENTRY	"show_super_vlan"
#define NPD_DBUS_VLAN_METHOD_CONFIG_PORT_MEMBER_PRIVATE    "netif_private_vlan"
#define NPD_DBUS_VLAN_METHOD_CONFIG_PORT_MEMBER_ISOLATE    "netif_isolate_group"

#define NPD_DBUS_VLAN_METHOD_CONFIG_VLAN_PRIVATE            "vlan_private"
#define NPD_DBUS_VLAN_METHOD_CONFIG_ASSOC_MAC                "vlan_assoc_mac"
#define NPD_DBUS_VLAN_METHOD_SHOW_ASSOC_MAC                "vlan_assoc_mac_show"
#define NPD_DBUS_VLAN_METHOD_CONFIG_ASSOC_SUBNET             "vlan_assoc_subnet"
#define NPD_DBUS_VLAN_METHOD_SHOW_ASSOC_SUBNET               "show_assoc_subnet_vlan"
#define NPD_DBUS_VLAN_METHOD_CONFIG_PORT_MODE                "vlan_access_mode"
#define NPD_DBUS_VLAN_METHOD_CONFIG_NETIF_SUBNET             "vlan_netif_subnet_based"
#define NPD_DBUS_VLAN_METHOD_CONFIG_NETIF_MAC                 "vlan_netif_mac_based"
#define NPD_DBUS_VLAN_METHOD_CONFIG_NETIF_QINQ_MODE          "vlan_netif_access_qinq"
#define NPD_DBUS_VLAN_METHOD_CONFIG_NETIF_QINQ_MISS_DROP           "vlan_netif_qinq_drop_miss"
#define NPD_DBUS_VLAN_METHOD_CONFIG_NETIF_QINQ_XLATE               "vlan_netif_qinq_xlate"
#define NPD_DBUS_VLAN_METHOD_CONFIG_NETIF_TPID                      "vlan_netif_tpid"
#define NPD_DBUS_VLAN_METHOD_CONFIG_NETIF_INNER_TPID                "vlan_netif_inner_tpid"
#define NPD_DBUS_VLAN_METHOD_SHOW_NETIF_QINQ_XLATE                  "vlan_netif_show_xlate"
#define NPD_DBUS_VLAN_METHOD_CONFIG_QINQ_GLOBAL_TPID                "vlan_qinq_global_tpid"

#define NPD_DBUS_VLAN_METHOD_CONFIG_ELINE                  			"vlan_eline"
#define NPD_DBUS_VLAN_METHOD_CONFIG_NETIF_ELINE                  	"vlan_netif_eline"


#ifdef HAVE_PRIVATE_VLAN
#define NPD_DBUS_VLAN_METHOD_CONFIG_PVLAN_PRIMARY		"config_pvlan_primary"
#define NPD_DBUS_VLAN_METHOD_CONFIG_PVLAN_ASSOC			"config_pvlan_assoc"
#define NPD_DBUS_VLAN_METHOD_CONFIG_PVLAN_PROMICUOUS    "config_pvlan_promis"
#define NPD_DBUS_VLAN_METHOD_CONFIG_PVLAN_ISOLATE    	"config_pvlan_isolate"
#define NPD_DBUS_VLAN_METHOD_GET_NEXT_PVLAN_INFO    	"get_next_pvlan_info"
#define NPD_DBUS_VLAN_METHOD_GET_PVLAN_MEMBER    		"get_pvlan_member"
#define NPD_DBUS_VLAN_METHOD_GET_NEXT_PVLAN_MAP    		"get_pvlan_map"

#define NPD_DBUS_VLAN_METHOD_SHOW_PVLAN_ALL    			"show_pvlan_all"
#endif
...
/*****************************************************************************************
 * DESCRIPTION:
 * 	arg lists for method NPD_DBUS_VLAN_METHOD_GET_VLAN_BASE_INFO
 *
 * INPUT:
 *	uint16 vlan id	 - vlanId    //points to vlan that'll be config.
 *
 * OUTPUT:
 *	uint32 ret - ret			//npd operation return value,indicates whether it success.
 *	uint32 stat                       // vlan status
 *
 *****************************************************************************************/
#define NPD_DBUS_VLAN_METHOD_GET_VLAN_BASE_INFO		"get_vlan_base_info"

/*****************************************************************************************
 * DESCRIPTION:
 * 	arg lists for method NPD_DBUS_VLAN_METHOD_GET_VLAN_VNAME_BASE_INFO
 *
 * INPUT:
 *	vlanname	 - string    //points to vlan that'll be config.
 *
 * OUTPUT:
 *	uint32 ret - ret			//npd operation return value,indicates whether it success.
 *	uint32 stat                       // vlan status
 *
 *****************************************************************************************/
#define NPD_DBUS_VLAN_METHOD_GET_VLAN_VNAME_BASE_INFO		"get_vlan_vname_base_info"
...
/*****************************************************************************************
 * DESCRIPTION:
 * 	arg lists for method NPD_DBUS_VLAN_METHOD_GET_VLAN_MEMBERS
 *
 * INPUT:
 *	uint16 vlan id	 - vlanId    //points to vlan that'll be config.
 *
 ...
 *
 *****************************************************************************************/
#define NPD_DBUS_VLAN_METHOD_GET_VLAN_MEMBERS		"get_vlan_members"

/*****************************************************************************************
 * DESCRIPTION:
 * 	arg lists for method NPD_DBUS_VLAN_METHOD_GET_PRIVLAN_MEMBERS
 *
 * INPUT:
 *	uint16 vlan id	 - vlanId    //points to vlan that'll be config.
 *
...
#define NPD_DBUS_VLAN_METHOD_GET_PRIVLAN_MEMBERS		"get_privlan_members"
...
#define NPD_DBUS_VLAN_METHOD_GET_ISOLATE_GROPU_MEMBERS		"get_isolate_group_members"
...
/*****************************************************************************************
 * DESCRIPTION:
 * 	arg lists for method NPD_DBUS_VLAN_METHOD_SHOW_VLAN_PORT_MEMBERS_VNAME_V1
 *
 * INPUT:
 *	string vlan name - vlanName	//vlan struct's member
 *
...
/*****************************************************************************************
 * DESCRIPTION:
 * 	arg lists for method NPD_DBUS_VLAN_METHOD_SHOW_VLANLIST_PORT_MEMBERS_V1
 *
 * INPUT:
 *	NONE
 *
...
/*****************************************************************************************
 * DESCRIPTION:
 * 	arg lists for method NPD_DBUS_VLAN_METHOD_SHOW_VLANLIST_PORT_MEMBERS_V2
 *
 * INPUT:
 *	NONE
 *
...
#define	NPD_DBUS_VLAN_METHOD_SET_ONE_PORT_INNER_PVID		"set_one_port_inner_pvid"

/*****************************************************************************************
 * DESCRIPTION:
 * 	arg lists for method NPD_DBUS_VLAN_METHOD_NEXT_VLAN_INDEX
 *
 * INPUT:
 *	vid -- vid  
 *
 ...
 *
 *****************************************************************************************/
#define	NPD_DBUS_VLAN_METHOD_NEXT_VLAN_INDEX				"get_next_vlan_index"

/*****************************************************************************************
 * DESCRIPTION:
 * 	arg lists for method NPD_DBUS_VLAN_METHOD_NEXT_PRIVLAN_INDEX
 *
 * INPUT:
 *	vid -- vid  
 *
 ...
 *
 *****************************************************************************************/
#define	NPD_DBUS_VLAN_METHOD_NEXT_PRIVLAN_INDEX				"get_next_privlan_index"
...
/*****************************************************************************
*	DESCRIPTION: 
*			This method show zhe vlan exists or doesn't
...
*			NPD_FAILURE
********************************************************************************/
#define NPD_DBUS_VLAN_METHOD_CHECK_VLAN_EXIST "check_vlan_exist"
...
#define NPD_DBUS_VLAN_METHOD_CHECK_PORT_VLAN "check_port_vlan"

#define NPD_DBUS_VLAN_METHOD_SET_PORT_AUTH_FAIL_VLAN "set_port_auth_fail_vlan"
...
/*****************************************************************************************
 * DESCRIPTION:
 * 	arg lists for method NPD_DBUS_FDB_METHOD_CONFIG_FDB_STATIC_DELETE_WITH_TRUNK
 *
 * INPUT:
 *	UNSIGNED INT   - TRUNK_NO      //destination  trunk which forward to
 * OUTPUT:
...
#define NPD_DBUS_FDB_METHOD_CONFIG_FDB_STATIC_DELETE_WITH_TRUNK    "set_fdb_static_delete_trunk"
...
#define NPD_DBUS_FDB_METHOD_SHOW_FDB_SINGLE_UNIT_TABLE             "show_single_unit_table"
/*****************************************************************************************
 * DESCRIPTION:
...
/*****************************************************************************************
 * DESCRIPTION:
 * 	arg lists for method NPD_DBUS_AGGREGATOR_METHOD_CREATE_LAG_ONE 
 *
 * INPUT:
 *	uint16 trunk id	 - aggId    //points to agg that'll be created.
 *	string trunk name - trunkName  //agg struct's member
 *
 * OUTPUT:
 *	uint32 ret		 - ret		 //npd operation return value,indicates whether it success.
 *
 *****************************************************************************************/
#define NPD_DBUS_AGGREGATOR_METHOD_MODE_CHANGE           "aggregator_mode_change"

/*****************************************************************************************
 * DESCRIPTION:
 * 	arg lists for method NPD_DBUS_METHOD_SHOW_LACP_RUNNING_CONFIG 
 *
 * INPUT:
 *	
 *
 * OUTPUT:
 *	string showStr		 - showStr		 //lacp's configuration
 *
 *****************************************************************************************/
#define NPD_DBUS_METHOD_SHOW_LACP_RUNNING_CONFIG         "show_lacp_running_config"

#define NPD_DBUS_AGGREGATOR_GET_BY_TRUNKID  "get_aggregator_infomation_by_trunk_id"
/*****************************************************************************************
 * DESCRIPTION:
...
#define NPD_DBUS_TRUNK_METHOD_CONFIG_UPDATE_TRUNKNAME			"config_trunk_update_name"
/*****************************************************************************************
 * DESCRIPTION:
...
*      
*************************************************/
#define NPD_DBUS_TRUNK_METHOD_CHECK_TRUNK_EXIST     "check_trunk_exist"

#define NPD_DBUS_TRUNK_METHOD_V_CONFIG_CASCADE      "config_vtrunk_cascade"

#define NPD_DBUS_TRUNK_METHOD_V_CONFIG_VLAG         "config_vtrunk_id"
#define NPD_DBUS_TRUNK_METHOD_V_CONFIG_LOCAL        "config_vtrunk_local_link"
...
/************************************************************************
 * DESCRIPTION:
 * 	arg lists for method NPD_DBUS_CASCADE_PRODUCT_BOX
 *
 * INPUT:
 *		
 * 	
 ...
 *			NPD_SUCCESS
 *			NPD_FAILURE
 *      int: type   0-chassis 1-box
 *
 ***********************************************************************/

#define NPD_DBUS_CASCADE_PRODUCT_BOX "product_box_flag"

/************************************************************************
 * DESCRIPTION:
 * 	arg lists for method NPD_DBUS_CASCADE_UNITNO
 *
 * INPUT:
 *	   UINT32: unitno	
 * 	
...
#define NPD_DBUS_CASCADE_UNITNO "cascade_unitno"

/*The configuration that need dbus relay*/
#define NPD_DBUS_RELAY_OBJPATH "/aw/dbus_relay"
#define NPD_DBUS_RELAY_INTERFACE "aw.dbus_relay"
...
/*****************************************************************************
********************************************************************************/
#define NPD_DBUS_ETHPORTS_INTERFACE_METHOD_SHOW_ETHPORT_RATE "show_ethport_rate"
...
* 			uint64 - crc error
********************************************************************************/
#define NPD_DBUS_ETHPORTS_METHOD_CLEAR_STACK_STAT_BY_SLOTNO_AND_PORTNO   "clear_stack_stat_by_slotno_and_portno"
/*****************************************************************************
*  DESCRIPTION: 
*			This method should also work for box product
*			arg lists for method NPD_DBUS_ETHPORTS_METHOD_CLEAR_STACK_STAT_BY_SLOTNO_AND_PORTNO
*
*  INPUT:
...
#define NPD_DBUS_ETHPORTS_METHOD_SHOW_PORT_STAT_BY_SLOTNO_AND_PORTNO "show_port_stat_by_slotno_and_portno"

/*****************************************************************************
*  DESCRIPTION: 
*			This method should also work for box product
*			arg lists for method NPD_DBUS_ETHPORTS_METHOD_SHOW_PORT_STAT_BY_SLOTNO_AND_PORTNO
*
*  INPUT:
*	 	unsigned char - slot_no
*            unsigned char -  port_no
...
#define NPD_DBUS_ETHPORTS_METHOD_GET_NEXT_STACK_PORT "get_next_stack_port"

/*****************************************************************************
*  DESCRIPTION: 
*			This method should also work for box product
*			arg lists for method NPD_DBUS_ETHPORTS_INTERFACE_METHOD_SHOW_ETHPORT_SFP
*
*  INPUT:
*	 	None.
*
...
#define NPD_DBUS_ETHPORTS_INTERFACE_METHOD_CONFIG_PORTDESC "config_eth_port_desc"
/************************************************************************
 * DESCRIPTION:
...
#define NPD_DBUS_ETHPORTS_INTERFACE_METHOD_CONFIG_PORT_EEE  "config_eth_port_eee"

#define NPD_DBUS_ETHPORTS_INTERFACE_METHOD_GET_PORT_EEE  "get_eth_port_eee"
...
#define NPD_DBUS_ETHPORTS_INTERFACE_METHOD_CONFIG_RATELIMIT "config_eth_port_ratelimit"
...
#define NPD_DBUS_ETHPORTS_INTERFACE_METHOD_SHOW_SWITCHPORT "show_switch_port"
#define NPD_DBUS_ETHPORTS_INTERFACE_METHOD_SWITCHPORT_EXIST "switch_port_exist"
...
/*****************************************************************************
*	DESCRIPTION: 
*			This method should set lacp for port;
...
*			NPD_FAILURE
********************************************************************************/
#define NPD_DBUS_ETHPORTS_INTERFACE_METHOD_CONFIG_PORT_LACP  "config_eth_port_lacp"
#define NPD_DBUS_ETHPORTS_INTERFACE_METHOD_CONFIG_ALL_PORT_LACP "config_global_lacp"
/*****************************************************************************
*	DESCRIPTION: 
*			This method should show arp;
...
#define NPD_DBUS_VLAN_METHOD_SHOW_NETIF_QINQ_XLATE_RUNNING        "show_netif_xlate_runconfig"
...
*
*	INPUT:
*	 	uint32 ethindex    //current netif_index, 0 for first index
*	
*	OUTPUT:  // in the order as they are appended in the dbus message.		
*		uint32 ethindex    //next netif_index
********************************************************************************/
#define NPD_DBUS_ETHPORTS_INTERFACE_METHOD_NEXT_GINDEX "get_next_netifindex"
...
/************************************************************************
 * DESCRIPTION:
 * 	show all board temperature and threshold
 *
 * INPUT:
 * 
 *		NONE
 ...
 *
 ***********************************************************************/
#define NPD_DBUS_DEVICE_METHOD_SHOW_TEMPER	 "show_board_temp"

#define NPD_DBUS_DEVICE_METHOD_TEMPER_THRESHOLD	 "config_temper_threshold"

#define NPD_DBUS_ETHPORTS_INTERFACE_METHOD_SHOW_CPU_STATS "show_ethport_cpu_rx_stats" 

#define NPD_DBUS_ETHPORTS_INTERFACE_METHOD_CLEAR_CPU_STATS "clear_ethport_cpu_rx_stats" 
...
/************************************************************************
 * DESCRIPTION:
 * 	arg lists for method NPD_DBUS_METHOD_CONFIG_NO_MIRROR;in order to 
 *    into mirror mode;
 *
 * INPUT:
 * 		uint32 - profile id
 ...
 *
 ***********************************************************************/
#define NPD_DBUS_METHOD_CONFIG_NO_MIRROR			 "config_no_mirror"
...
/************************************************************************
 * DESCRIPTION:
 * 	arg lists for method NPD_DBUS_METHOD_APPEND_MIRROR_REMOTE_VLAN_CREATE;in order to 
 *    config mirror remote vlan;
 *
 * INPUT:
 *   uint32- profile
 *	uint16-vid
 ...
 *
 ***********************************************************************/
#define NPD_DBUS_METHOD_APPEND_MIRROR_REMOTE_VLAN_CREATE   "config_mirror_remote_vlan"

/************************************************************************
 * DESCRIPTION:
 * 	arg lists for method NPD_DBUS_METHOD_APPEND_MIRROR_REMOTE_VLAN_DEL;in order to 
 *    delete mirror remote vlan;
 *
 * INPUT:
 *    uint32-profile
 *	uint16-vid
 ...
 *
 ***********************************************************************/
#define NPD_DBUS_METHOD_APPEND_MIRROR_REMOTE_VLAN_DEL   "del_mirror_remote_vlan"
...
#define NPD_DBUS_METHOD_MIRROR_SHOW_FDB  "show_mirror_fdb"
...
#define NPD_DBUS_METHOD_SET_PROFILE_PROFILE_TABLE     "config_proflie_to_profile_map_table"
/************************************************************************
 * DESCRIPTION:
 *	set up to qos profile
 *
...
#define NPD_DBUS_METHOD_DEFAULT_PROFILE_TABLE   "default_to_profile_map_table"
	/************************************************************************
	 * DESCRIPTION:
...
#define NPD_DBUS_METHOD_DELETE_DEFAULT_PROFILE_TABLE   "delete_default_to_profile_map_table"
#define NPD_DBUS_METHOD_PORT_QOS_REMARK                  "qos_port_remark"
		/************************************************************************
		 * DESCRIPTION:
		 *	delte dscp to qos profile
		 *
...
#define NPD_DBUS_METHOD_SET_PORT_TRUST_L3DSCP_MODE     	 	"set_port_trust_mode_l3dscp"
#define NPD_DBUS_METHOD_SET_PORT_TRUST_L3REMAP_MODE     	"set_port_trust_mode_l3remap"
/************************************************************************
 * DESCRIPTION:
 ...
 *
 ***********************************************************************/
#define NPD_DBUS_METHOD_CONFIG_PACKETCOLOR		    "config_policer_packetcolor"
/************************************************************************
 * DESCRIPTION:
 *	set cir cbs of policer 
 *
...
#define NPD_DBUS_METHOD_GET_POLICER		    "get_policer_info"
...
#define NPD_DBUS_METHOD_SHOW_QOS_RUNNIG_CONFIG		"qos_model_show_running"
/************************************************************************
 * DESCRIPTION:
 * 	show running for qos-model config
 *
 * INPUT:
 *		NONE
 *
...
#define NPD_DBUS_METHOD_QUEUE_DROP                "set_queue_drop_mode"
/************************************************************************
 * DESCRIPTION:
...
#define NPD_DBUS_METHOD_DEFAULT_QUEQUE			 "def_queue_alogrithm"
/************************************************************************
 * DESCRIPTION:
 *	set queue scheduler mode
 *
...
#define NPD_DBUS_QOS_CONFIG_FLOW_CONTROL	"config_flow_control"
#define NPD_DBUS_QOS_SHOW_FLOW_CONTROL      "show_flow_control"
...
#define NPD_DBUS_METHOD_ACL_SHOW_RUNNIG_CONFIG		"acl_show_running_config"
#define NPD_DBUS_METHOD_ACL_RULE_SHOW_CONFIG		"acl_show_rule"
#define NPD_DBUS_METHOD_ACL_IPV6_SHOW_CONFIG		"acl_show_ipv6_srcordstip"
...
#define NPD_DBUS_METHOD_SWITCH_VOICE_VLAN 	"config_voice_vlan_enable"
...
/************************************************************************
 * DESCRIPTION:
 * 	arg lists for method NPD_DBUS_ETHPORTS_METHOD_UNBIND_ACL_GROUP
 *
 * INPUT:
 * 	 uint32 - node_flag  		//port mode 0,vlan mode 1
 *	 uint32 - g_index			//port index or vlan index
...
#define NPD_DBUS_ETHPORTS_METHOD_UNBIND_ACL_GROUP "unbind_acl_group_on_port"
...
#define NPD_DBUS_ETHPORTS_INTERFACE_METHOD_CONFIG_PORT_PROTECT    "config_eth_protect"
...
*
********************************************************************************/
#define STP_DBUS_METHOD_GET_BROAD_TYPE "broad_type"
...
#define RSTP_DBUS_METHOD_CONFIG_PORT_ROOTGUARD "brg_port_rootguard"
/************************************************************************
 * DESCRIPTION:
 * 	arg lists for method RSTP_DBUS_METHOD_CONFIG_PORT_BPDUGUARD
 *
 * INPUT:
 *
 *		uint32 - port_index  //port index
 *		uint32 - mstd			//mst instance id
 *		uint32 - value 	//config bpdu guard 1 enable 0 disable
 *
 * OUTPUT:
 *		
 *		STP_OK				// succued 
...
#define RSTP_DBUS_METHOD_CONFIG_PORT_BPDUGUARD "brg_port_bpduguard"
...
/************************************************************************
 * DESCRIPTION:
 * 	arg lists for method RSTP_DBUS_METHOD_SHOW_SPANTREE_NEXTPORT,this is API,not a command.
 *		the message return the RSTP port information next to current port_index.
 *
 * INPUT:
 *
 *  	uint32	- port_index				// port index
 ...
 *				uint16	port Desi port
 ***********************************************************************/
#define RSTP_DBUS_METHOD_SHOW_SPANTREE_NEXTPORT      "brg_spann_tree_nextport"
/************************************************************************
 * DESCRIPTION:
...
#define MSTP_DBUS_METHOD_GET_NEXTPORT_INFO  "mstp_nextport_info"
...
*
*/
#define MLD_DBUS_BUSNAME	"aw.mld"
#define MLD_DBUS_OBJPATH	"/aw/mld"
#define MLD_DBUS_INTERFACE	"aw.mld"

#define MLD_SNP_DBUS_METHOD_SET_ENABLE                     "mld_snp_set_enable"
#define MLD_SNP_DBUS_METHOD_SET_CFG                        "mld_snp_set_config"
#define MLD_SNP_DBUS_METHOD_SET_VLAN_QUERIER               "mld_snp_set_vlan_querier"
#define MLD_SNP_DBUS_METHOD_SET_VLAN_REPORT                "mld_snp_set_vlan_report"
#define MLD_SNP_DBUS_METHOD_SET_STATIC_GROUP               "mld_snp_set_static_group"
#define MLD_SNP_DBUS_METHOD_SET_STATIC_RTPORT              "mld_snp_set_static_route_port"
#define MLD_SNP_DBUS_METHOD_CLR_MCGROUP                    "mld_snp_clear_mcgroup"
#define MLD_SNP_DBUS_METHOD_CLR_RTPORT                     "mld_snp_clear_rtport"
#define MLD_SNP_DBUS_METHOD_GET_CFG                        "mld_snp_get_cfg"
#define MLD_SNP_DBUS_METHOD_GET_VLAN_CFG                   "mld_snp_get_vlan_cfg"
#define MLD_SNP_DBUS_METHOD_GET_VLAN_RTPORT                "mld_snp_get_vlan_rtport"
#define MLD_SNP_DBUS_METHOD_GET_VLAN_MCGROUP               "mld_snp_get_vlan_mcgroup"
#define MLD_SNP_DBUS_METHOD_SHOW_RUNNING_CONFIG            "mld_snp_show_running_config"
...
/*****************************************************************
 * DESCRIPTION:
 * 	arg lists for method IGMP_SNP_DBUS_METHOD_IGMP_SNP_DEBUG
 * INPUT:
...
/*****************************************************************
 * DESCRIPTION:
 * 	arg lists for method IGMP_SNP_DBUS_METHOD_IGMP_SNP_CONFIG_PARAMETER_GET
 *
 * INPUT:
 *		NULL
 *
...
/*****************************************************************
 * DESCRIPTION:
 * 	arg lists for method IGMP_SNP_DBUS_METHOD_CHECK_IGMP_SNP_STATUS
 *
 * INPUT:
 *		NONE
 *
...
/*****************************************************************
 * DESCRIPTION:
 * 	arg lists for method IGMP_SNP_DBUS_METHOD_IGMP_SNP_ROUTE_PORT_SHOW_RUNNING
 *
 * INPUT:
 *		NONE
 *
...
/*****************************************************************
 * DESCRIPTION:
 * 	arg lists for method NPD_DBUS_METHOD_SYSTEM_ENVMONITOR_CONTROL
 *
 * INPUT:
 *		uint32 	-  watchdog enable(1) or disable(0) flag
 *
 ...
 *		
*****************************************************************/
#define NPD_DBUS_METHOD_SYSTEM_ENVMONITOR_CONTROL	"diag_envmonitor_ctrl"


/*****************************************************************
 * DESCRIPTION:
 * 	arg lists for method NPD_DBUS_METHOD_SYSTEM_RESET_BOARD
 *
 * INPUT:
 *		uint32 	-  specified slot no
 *
 * OUTPUT:
 *		uint32 	- operation return code
 *		
*****************************************************************/
#define NPD_DBUS_METHOD_SYSTEM_RESET_BOARD			"diag_reset_board"



/*****************************************************************
 * DESCRIPTION:
 * 	arg lists for method NPD_DBUS_METHOD_DBTABLE_SHOW
 *
 * INPUT:
 *		string 	-  dbtable name
 *
 * OUTPUT:
 *		string 	- dbtable content
 *		
*****************************************************************/
#define NPD_DBUS_METHOD_DBTABLE_SHOW			"diag_dbtable_show"
...
#define NPD_DBUS_CONFIG_ARP_INSPECTION_TRUST "CONFIG_ARP_INSPECTION_TRUST"

#define NPD_DBUS_CONFIG_ARP_INSPECTION_STATISTICS   "npd_arp_inspection_statistic"

#define NPD_DBUS_CONFIG_ARP_INSPECTION_CLEAR        "npd_arp_inspection_clear"

#define NPD_DBUS_CONFIG_ARP_INSPECTION_VALIDATE_TYPE "CONFIG_ARP_INSPECTION_VALIDATE_TYPE"

#define NPD_DBUS_CONFIG_ARP_INSPECTION_SHOW_GLOBAL "ARP_INSPECTION_SHOW_GLOBAL"

#define NPD_DBUS_CONFIG_ARP_INSPECTION_SHOW_VLAN "ARP_INSPECTION_SHOW_VLAN"

#define NPD_DBUS_CONFIG_ARP_INSPECTION_SHOW_TRUST "ARP_INSPECTION_SHOW_TRUST"

#define NPD_DBUS_CONFIG_ARP_INSPECTION_SHOW_VLAN_BY_VID "ARP_INSPECTION_SHOW_VLAN_BY_VID"
...
#define DHCPD_DBUS_BUSNAME "aw.dhcpd"
#define DHCPD_DBUS_OBJPATH "/aw/dhcpd"
#define DHCPD_DBUS_INTERFACE "aw.dhcpd"

#define DHCP_DBUS_METHOD_SAVE_DHCP_LEASE			"dhcp_save_lease"
#define DHCPD_DBUS_INTERFACE_METHOD_SERVICE_ENABLE            "dhcpd_service_enable"      
#define DHCPD_DBUS_INTERFACE_METHOD_SERVER_DOMAIN_NAME        "dhcpd_service_domain_name"
#define DHCPD_DBUS_INTERFACE_METHOD_SERVER_DNS_ADDR           "dhcpd_service_dns_addr"
#define DHCPD_DBUS_INTERFACE_METHOD_SERVER_DEL_DNS_ADDR           "dhcpd_service_dns_delete_addr"
#define DHCPD_DBUS_INTERFACE_METHOD_SERVER_WINS_ADDR          "dhcpd_service_wins_addr"
#define DHCPD_DBUS_INTERFACE_METHOD_SERVER_GATEWAY_ADDR          "dhcpd_service_gateway_addr"
#define DHCPD_DBUS_INTERFACE_METHOD_SERVER_DEFAULT_LEASE_TIME "dhcpd_service_default_lease_time"
#define DHCPD_DBUS_INTERFACE_METHOD_SERVER_MAX_LEASE_TIME     "dhcpd_service_max_lease_time"
#define DHCPD_DBUS_INTERFACE_METHOD_SERVER_PING_CHECK         "dhcpd_sping_chk" 
#define DHCPD_DBUS_INTERFACE_METHOD_HOST_STATIC_ADD           "dhcpd_host_static_add"
#define DHCPD_DBUS_INTERFACE_METHOD_HOST_STATIC_DEL           "dhcpd_host_static_del"
#define DHCPD_DBUS_INTERFACE_METHOD_POOL_CREATE               "dhcpd_pool_create"
#define DHCPD_DBUS_INTERFACE_METHOD_POOL_DELETE               "dhcpd_pool_delete"
#define DHCPD_DBUS_INTERFACE_METHOD_POOL_ADD_RANGE            "dhcpd_pool_add_range" 
#define DHCPD_DBUS_INTERFACE_METHOD_POOL_DEL_RANGE            "dhcpd_pool_del_range"
#define DHCPD_DBUS_INTERFACE_METHOD_POOL_ADD_FORBIDDEN        "dhcpd_pool_add_forbidden"
#define DHCPD_DBUS_INTERFACE_METHOD_POOL_DEL_FORBIDDEN        "dhcpd_pool_del_forbidden"
#define DHCPD_DBUS_INTERFACE_METHOD_POOL_NETBIOS_NODE_TYPE    "dhcpd_pool_netbios_node_type"
#define DHCPD_DBUS_INTERFACE_METHOD_POOL_OPTION_43_60         "dhcpd_pool_option_43_60"
#define DHCPD_DBUS_INTERFACE_METHOD_POOL_OPTION_CODE          "dhcpd_pool_option_code"
#define DHCPD_DBUS_INTERFACE_METHOD_POOL_NO_OPTION_CODE       "dhcpd_pool_no_option_code"
#define DHCPD_DBUS_INTERFACE_METHOD_POOL_DNS_ADDR             "dhcpd_pool_dns_addr"
#define DHCPD_DBUS_INTERFACE_METHOD_POOL_WINS_ADDR            "dhcpd_pool_wins_addr"
#define DHCPD_DBUS_INTERFACE_METHOD_POOL_GATEWAY_ADDR            "dhcpd_pool_gateway_addr"
#define DHCPD_DBUS_INTERFACE_METHOD_POOL_DEFAULT_LEASE_TIME   "dhcpd_pool_default_lease_time"
#define DHCPD_DBUS_INTERFACE_METHOD_POOL_MAX_LEASE_TIME       "dhcpd_pool_max_lease_time"
#define DHCPD_DBUS_INTERFACE_METHOD_POOL_DOMAIN_NAME          "dhcpd_pool_domain_name"
#define DHCPD_DBUS_INTERFACE_METHOD_INTF_SERVICE_ENABLE       "dhcpd_intf_service_enable"
#define DHCPD_DBUS_INTERFACE_METHOD_INTF_SIGNAL_SERVER        "dhcpd_intf_ss"
#define DHCPD_DBUS_INTERFACE_METHOD_INTF_SERVICE_DISABLE      "dhcpd_intf_service_disable"
#define DHCPD_DBUS_INTERFACE_METHOD_INTF_BIND_POOL            "dhcpd_intf_bind_pool"
#define DHCPD_DBUS_INTERFACE_METHOD_INTF_UNBIND_POOL          "dhcpd_intf_unbind_pool"
#define DHCPD_DBUS_INTERFACE_METHOD_SHOW_SERVICE_INFO         "dhcpd_show_service_info"
#define DHCPD_DBUS_INTERFACE_METHOD_SHOW_INTF_INFO            "dhcpd_show_intf_info"
#define DHCPD_DBUS_INTERFACE_METHOD_GET_CURR_INTF_INFO        "dhcpd_get_curr_intf_info"
#define DHCPD_DBUS_INTERFACE_METHOD_SHOW_POOL_INFO            "dhcpd_show_pool_info"
#define DHCPD_DBUS_INTERFACE_METHOD_GET_CURR_POOL_INFO        "dhcpd_get_curr_pool_info"
#define DHCPD_DBUS_INTERFACE_METHOD_SHOW_HOST_INFO            "dhcpd_show_host_info"
#define DHCPD_DBUS_INTERFACE_METHOD_SHOW_LEASE_SPEC_INFO       "dhcpd_show_lease_spec_info"
#define DHCPD_DBUS_INTERFACE_METHOD_SHOW_LEASE_SPEC_INFO_COUNT       "dhcpd_show_lease_spec_info_cnt"

#define DHCPD_DBUS_INTERFACE_METHOD_SHOW_RUNNING_GLOBAL_CONFIG "dhcpd_show_running_global_config"
#define DHCPD_DBUS_INTERFACE_METHOD_SHOW_RUNNING_POOL_CONFIG   "dhcpd_show_running_pool_config"
#define DHCPD_DBUS_INTERFACE_METHOD_SHOW_RUNNING_INTF_CONFIG   "dhcpd_show_running_intf_config"
#define DHCPD_DBUS_INTERFACE_METHOD_SHOW_RUNNING_HOST_CONFIG   "dhcpd_show_running_host_config"
#define DHCPD_DBUS_INTERFACE_METHOD_DEBUG_FLAG_SET               "dhcpd_debug_flag_set"
#define DHCPD_DBUS_INTERFACE_METHOD_SHOW_DEBUG_FLAG            "dhcpd_show_debug_flag"
#define DHCPD_DBUS_INTERFACE_METHOD_AUTO_INFO                   "dhcpd_ap_detect_and_intelligent_dhcp_info"
...
#define DHCPDV6_DBUS_BUSNAME    "aw.dhcpdv6"
#define DHCPDV6_DBUS_OBJPATH    "/aw/dhcpdv6"
#define DHCPDV6_DBUS_INTERFACE  "aw.dhcpdv6"

#define DHCPDV6_DBUS_INTERFACE_METHOD_GLOBAL_SET            "dhcpv6_g_set"
#define DHCPDV6_DBUS_INTERFACE_METHOD_POOL                  "dhcpv6_pool_set"
#define DHCPDV6_DBUS_INTERFACE_METHOD_POOL_DELETE           "dhcpv6_pool_del"
#define DHCPDV6_DBUS_INTERFACE_METHOD_POOL_DOMAIN           "dhcpv6_pl_domain"
#define DHCPDV6_DBUS_INTERFACE_METHOD_HOST_ADD              "dhcpv6_host_add"
#define DHCPDV6_DBUS_INTERFACE_METHOD_HOST_DELETE           "dhcpv6_host_del"
#define DHCPDV6_DBUS_INTERFACE_METHOD_INTERFACE_SET         "dhcpv6_if_set"
#define DHCPDV6_DBUS_INTERFACE_METHOD_POOL_PREFERRED_TIME   "dhcpv6_pl_t1_time"
#define DHCPDV6_DBUS_INTERFACE_METHOD_POOL_VALID_TIME       "dhcpv6_pl_t2_time"
#define DHCPDV6_DBUS_INTERFACE_METHOD_POOL_PREFERENCE       "dhcpv6_pl_preference"
#define DHCPDV6_DBUS_INTERFACE_METHOD_POOL_RAPID_COMMIT     "dhcpv6_pl_rapid"
#define DHCPDV6_DBUS_INTERFACE_METHOD_POOL_DNS              "dhcpv6_pl_dns"
#define DHCPDV6_DBUS_INTERFACE_METHOD_POOL_RANGE6           "dhcpv6_pl_range6"
#define DHCPDV6_DBUS_INTERFACE_METHOD_POOL_VENDOR           "dhcpv6_pl_vendor"
#define DHCPDV6_DBUS_INTERFACE_METHOD_GLOBAL_GET            "dhcpv6_g_get"
#define DHCPDV6_DBUS_INTERFACE_METHOD_HOST_NEXT_GET         "dhcpv6_next_get"
#define DHCPDV6_DBUS_INTERFACE_METHOD_POOL_GET_ONE          "dhcpv6_pl_get_one"
#define DHCPDV6_DBUS_INTERFACE_METHOD_POOL_GET_NEXT         "dhcpv6_pl_get_next"
#define DHCPDV6_DBUS_INTERFACE_METHOD_IF_GET_NEXT           "dhcpv6_if_get_next"
#define DHCPDV6_DBUS_INTERFACE_METHOD_NEXT_IA_GET           "dhcpv6_ia_get"
#define DHCPDV6_DBUS_INTERFACE_METHOD_IA_COUNT_GET          "dhcpv6_ia_cnt_get"
#define DHCPDV6_DBUS_INTERFACE_METHOD_SHOW_RUNNING          "dhcpv6_show_run"
 ...
 *
 ****************************/
#define DHCLIENT_DBUS_BUSNAME "aw.dhclient"
#define DHCLIENT_DBUS_OBJPATH "/aw/dhclient"
#define DHCLIENT_DBUS_INTERFACE "aw.dhclient"

#define DHCLIENT_DBUS_INTERFACE_METHOD_SHOW_RUNNING         "dhclient_show_run"
#define DHCLIENT_DBUS_INTERFACE_METHOD_CLIENT_ID    "dhclient_client_id"
#define DHCLIENT_DBUS_INTERFACE_METHOD_CLASS_ID     "dhclient_class_id"
#define DHCLIENT_DBUS_INTERFACE_METHOD_LEASE        "dhclient_lease"
#define DHCLIENT_DBUS_INTERFACE_METHOD_DEFAULT_ROUTE        "dhclient_gateway"
#define DHCLIENT_DBUS_INTERFACE_METHOD_INTERFACE     "dhclient_interface"
#define DHCLIENT_DBUS_INTERFACE_METHOD_ACTION       "dhclient_action"
#define DHCLIENT_DBUS_INTERFACE_METHOD_OPTION_DEFAULT     "dhclient_opt_default"
#define DHCLIENT_DBUS_INTERFACE_METHOD_OPTION_ADD     "dhclient_opt_add"
#define DHCLIENT_DBUS_INTERFACE_METHOD_OPTION_REMOVE     "dhclient_opt_del"
#define DHCLIENT_DBUS_INTERFACE_METHOD_SHOW_ONE         "dhclient_show_one"
#define DHCLIENT_DBUS_INTERFACE_METHOD_SHOW_NEXT        "dhclient_show_next"
...
#define NPD_DBUS_DHCP_RELAY_OBJPATH "/aw/npd/dhcpr"
#define NPD_DBUS_DHCP_RELAY_INTERFACE "aw.npd.dhcpr"

#define NPD_DBUS_DHCPR_METHOD_GLOBAL_ENABLE			 "endis_global_dhcp_relay"
#define NPD_DBUS_DHCPR_METHOD_INTF_ENABLE			 "endis_intf_dhcp_relay"
#define NPD_DBUS_DHCPR_METHOD_ADD_IP_HELPER         "dhcp_add_ip_helper"
#define NPD_DBUS_DHCPR_METHOD_DEL_IP_HELPER         "dhcp_del_ip_helper"
#define NPD_DBUS_DHCPR_METHOD_SHOW_IP_HELPER         "dhcp_show_ip_helper"
#define NPD_DBUS_DHCP_RELAY_METHOD_SHOW_RUNNING_INTF_CONFIG  "show_running_intf_dhcp_relay"
#define NPD_DBUS_DHCP_RELAY_METHOD_SHOW_RUNNING_GLOBAL_CONFIG "show_running_global_dhcp_relay"
 ...
 *
 ****************************/
#define NPD_DBUS_DHCPV6_RELAY_OBJPATH "/aw/npd/dhcp6r"
#define NPD_DBUS_DHCPV6_RELAY_INTERFACE "aw.npd.dhcp6r"

#define NPD_DBUS_DHCP6R_METHOD_GLOBAL           "npd_dhcp6r_g"
#define NPD_DBUS_DHCP6R_METHOD_INTERFACE        "npd_dhcp6r_if"
#define NPD_DBUS_DHCP6R_METHOD_SERVER           "npd_dhcp6r_server"
#define NPD_DBUS_DHCP6R_METHOD_NO_SERVER        "npd_dhcp6r_no_server"
#define NPD_DBUS_DHCP6R_METHOD_GLOBAL_SHOW      "npd_dhcp6r_g_s"
#define NPD_DBUS_DHCP6R_METHOD_INTERFACE_SHOW   "npd_dhcp6r_if_s"
#define NPD_DBUS_DHCP6R_METHOD_INTERFACE_SHOW_ONE   "npd_dhcp6r_if_s_o"
#define NPD_DBUS_DHCP6R_METHOD_SHOW_RUNNING     "npd_dhcp6r_sr"
...
#define NPD_DBUS_ACL_TIME_RANGE_NAME                        "acl_time_range_name"
#define NPD_DBUS_ACL_TIME_RANGE_ARG                         "acl_time_range_arg"
#define NPD_DBUS_ACL_ASSOCIATE_TIME_RANGE                   "acl_associate_time_range"
#define NPD_DBUS_NO_TIME_RANGE_NAME                         "no_time_range_name"
#define NPD_DBUS_NO_ACL_TIME_RANGE_ASSOCIATE                "no_acl_time_range_associate"
#define NPD_DBUS_ACL_SHOW_TIME_RANGE                        "acl_show_time_range"
#define NPD_DBUS_ACL_SHOW_TIME_RANGE_NAME                   "acl_show_time_range_name"
#define NPD_DBUS_ACL_SHOW_TIME_RANGE_BIND                   "acl_show_time_range_bind_with_acl"
#define NPD_DBUS_ACL_METHOD_MATCH_L4PORT_RANGE              "acl_match_l4port_range"
#define NPD_DBUS_ACL_POLICY_ROUTE_SUPPORT                   "acl_policy_route_support"

#define NPD_DBUS_ACL_METHOD_MATCH_ADD						"acl_match_add"
#define NPD_DBUS_ACL_METHOD_MATCH_DELETE					"acl_match_delete"
#define NPD_DBUS_ACL_METHOD_POLICY_ACTION					"acl_policy_action"
#define NPD_DBUS_ACL_METHOD_DELETE_POLICY_ACTION			"acl_delete_policy_action"

#define NPD_DBUS_ACL_METHOD_CONFIG_DIFFSERV					"acl_config_diffserv"
#define NPD_DBUS_METHOD_SHOW_DIFFSERV_SERVICE				"acl_show_config_diffserv"
#define NPD_DBUS_ACL_METHOD_CLASS_MAP_MATCH_ALL				"acl_class_map_match_all"
#define	NPD_DBUS_ACL_METHOD_NO_CLASS_MAP					"acl_no_class_map"
#define NPD_DBUS_ACL_METHOD_CLASS_MAP_RENAME				"acl_class_map_rename"
#define NPD_DBUS_ACL_METHOD_MATCH_CLASS_MAP					"acl_match_class_map"
#define NPD_DBUS_ACL_METHOD_NO_MATCH_CLASS_MAP				"acl_no_match_class_map"
#define NPD_DBUS_ACL_METHOD_POLICE_SIMPLE					"acl_police_simple"
/*end acl match actions*/
#define NPD_DBUS_ACL_METHOD_POLICY_MAP_IN					"acl_policy_map_in"
#define NPD_DBUS_ACL_METHOD_NO_POLICY_MAP					"acl_policy_map"
#define NPD_DBUS_ACL_METHOD_POLICY_MAP_RENAME				"acl_policy_map_rename"
#define NPD_DBUS_ACL_METHOD_CONFIG_CLASS					"acl_config_class"
#define NPD_DBUS_ACL_METHOD_CONFIG_NO_CLASS					"acl_clnfig_no_class"

#define NPD_DBUS_ACL_METHOD_NO_SERVICE_POLICY_IN			"acl_no_service_policy_in"
#define NPD_DBUS_ACL_METHOD_SERVICE_POLICY_IN				"acl_service_policy_in"
#define NPD_DBUS_ACL_METHOD_SERVICE_POLICY_ALL				"acl_service_policy_all"

#define NPD_DBUS_ACL_METHOD_NO_SERVICE_POLICY_ALL			"acl_no_service_policy_all"

#define NPD_DBUS_ACL_METHOD_SHOW_CLASS_MAP					"acl_show_class_map"
#define NPD_DBUS_ACL_METHOD_SHOW_DIFFSERV					"acl_show_diffserv"
#define NPD_DBUS_ACL_METHOD_SHOW_POLICY_MAP					"acl_show_policy_map"
#define NPD_DBUS_ACL_METHOD_SHOW_DIFFSERV_SERVICE_IN		"acl_show_diffserv_service_in"
#define NPD_DBUS_ACL_METHOD_SHOW_DIFFSERV_SERVICE_BRIEF		"acl_show_service_brief"
#define NPD_DBUS_ACL_METHOD_SHOW_POLICY_MAP_INTERFACE		"acl_show_policy_map_interface"
#define NPD_DBUS_ACL_METHOD_SHOW_SERVICE_POLICY_IN			"acl_show_service_policy_in"

#define NPD_DBUS_ACL_SHOW_CMAP_LIST						"acl_show_cmap_list"
#define NPD_DBUS_ACL_SHOW_PMAP_LIST						"acl_show_pmap_list"
#define NPD_DBUS_ACL_SHOW_CMAP_NAME			    			"acl_show_cmap_name"
#define NPD_DBUS_ACL_SHOW_PMAP_NAME			    			"acl_show_pmap_name"
#define NPD_DBUS_ACL_SHOW_SERVICE_POLICY					"acl_show_service_policy"
#define NPD_DBUS_ACL_SHOW_VMAP_NAME                         "acl_show_vmap_name"
#define NPD_DBUS_ACL_SHOW_SRV_BOARD                         "acl_show_srv_board"

#define NPD_DBUS_ACL_VOICE_VLAN_CONFIG						"acl_voice_vlan_config"
#define NPD_DBUS_ACL_NO_VOICE_VLAN_CONFIG					"acl_voice_no_vlan_config"
#define NPD_DBUS_ACL_VOICE_VLAN_TRUST_CONFIG				"acl_voice_vlan_trust_config"
#define NPD_DBUS_ACL_VOICE_VLAN_SET_DOT1P_CONFIG			"acl_voice_vlan_set_dot1p_config"
#define	NPD_DBUS_ACL_VOICE_VLAN_SHOW_CONFIG					"acl_voice_vlan_show_config"
#define NPD_DBUS_ACL_SHOW_VOICE_VLAN_SERVICE				"acl_show_config_voice_vlan"

#define NPD_DBUS_ACL_METHOD_ACL_GROUP_CONFIG                "acl_group_config"
#define NPD_DBUS_ACL_METHOD_NO_ACL_GROUP_CONFIG             "no_acl_group_config"
#define NPD_DBUS_ACL_METHOD_ACL_GROUP_ADD_DESP              "acl_group_add_description"
#define NPD_DBUS_ACL_METHOD_ACL_GROUP_DELETE_DESP           "acl_group_delete_description"
#define NPD_DBUS_ACL_METHOD_ACL_GROUP_ADD_RULE              "acl_group_add_rule"
#define NPD_DBUS_ACL_METHOD_ACL_GROUP_DELETE_RULE           "acl_group_delete_rule"
#define NPD_DBUS_ACL_METHOD_ACL_GROUP_DEPLOY                "acl_group_deploy"
#define NPD_DBUS_ACL_METHOD_ACL_GROUP_UNDEPLOY              "acl_group_undeploy"
#define NPD_DBUS_ACL_METHOD_ACL_GROUP_UNDEPLOY_ALL          "acl_group_undeploy_all"
#define NPD_DBUS_ACL_METHOD_ACL_GROUP_SHOW_DETAIL           "acl_group_show_detail"
#define NPD_DBUS_ACL_METHOD_ACL_GROUP_SHOW_ALL              "acl_group_show_all"
#define NPD_DBUS_ACL_METHOD_ACL_GROUP_INTF_SHOW             "acl_group_intf_show"
/*********************************
*
* end ACL Command
*
*********************************/
#define NPD_DBUS_CONFIG_IP_DHCP_RELAY_SHOW_GLOBAL "IP_DHCP_RELAY_SHOW_GLOBAL"
 ...
 *		
*****************************************************************/
#define NPD_DBUS_DHCP_SNP_METHOD_SHOW_GLOBAL_STATUS	"show_dhcp_snp_status"

/*****************************************************************
 * DESCRIPTION:
 * 	arg lists for method NPD_DBUS_DHCPSNP_METHOD_CONFIG_ETHPORT
 *
 * INPUT:
 *
 *		NONE
 ...
 *		
*****************************************************************/
#define NPD_DBUS_DHCP_SNP_METHOD_CONFIG_ETHPORT	"config_dhcp_eth_port"
#endif
...
#define NPD_DBUS_DHCP_SNP_VLAN_SHOW					"DHCP_SNP_VLAN_SHOW"

#define NPD_DBUS_DHCP_SNP_VLAN_SHOW_BY_VID						"DHCP_SNP_VLAN_SHOW_BY_VID"

#define NPD_DBUS_DHCP_SNP_OP82_INFORMATION_GLOBAL_GET				            "dhcp_snp_opt82_information_global_get"
#define NPD_DBUS_DHCP_SNP_OP82_GLOBAL_STATUS_GET                    "npd_dhcp_snp_opt82_global_get"

#define NPD_DBUS_DHCP_SNP_OP82_INTERFACE_SHOW						"DHCP_SNP_OP82_INTERFACE_SHOW"
#define NPD_DBUS_DHCP_SNP_OP82_INFORMATION_PORT_GET                 "npd_dbus_dhcp_snp_opt82_information_port_get"
...
/*****************************************************************
 * DESCRIPTION:
 * 	arg lists for method NPD_DBUS_DHCP_RELAY_METHOD_OPT82_ENABLE
 *
 * INPUT:
 *		NONE
 *
 ...
 *		
*****************************************************************/
#define NPD_DBUS_DHCP_RELAY_METHOD_OPT82_ENABLE			"dhcp_relay_endis_opt82"
...
/*****************************************************************************
*	DESCRIPTION: 
*			This method should set gvrp for port;
*			 NPD_DBUS_ETHPORTS_INTERFACE_METHOD_CONFIG_PORT_GVRP
*
*	INPUT:
*	 	isEnable - TRUE OR FALSE
*
...
*			NPD_FAILURE
********************************************************************************/
#define NPD_DBUS_ETHPORTS_INTERFACE_METHOD_CONFIG_PORT_GVRP  "config_eth_port_gvrp"
/*****************************************************************************
*	DESCRIPTION: 
*			This method should set gvrp registration for port;
*			 NPD_DBUS_ETHPORTS_INTERFACE_METHOD_CONFIG_PORT_REG_GVRP
*
*	INPUT:
*	 	isEnable - TRUE OR FALSE
*
...
*			NPD_FAILURE
********************************************************************************/
#define NPD_DBUS_ETHPORTS_INTERFACE_METHOD_CONFIG_REG_PORT_GVRP  "config_eth_port_reg_gvrp"
/*****************************************************************************
*	DESCRIPTION: 
*			This method should set gvrp global configuration;
*			 NPD_DBUS_ETHPORTS_INTERFACE_METHOD_CONFIG_GVRP
*
*	INPUT:
*	 	isEnable - TRUE OR FALSE
*
...
*			NPD_FAILURE
********************************************************************************/
#define NPD_DBUS_METHOD_CONFIG_GVRP  "config_global_gvrp"
/*****************************************************************************
*	DESCRIPTION: 
*			This method should set gvrp global timer configuration including hold timer, join timer, leave timer, leaveall timer;
*			 NPD_DBUS_ETHPORTS_INTERFACE_METHOD_CONFIG_GVRP_TIMER
*
*	INPUT:
*	 	timer_type - 
*              timer_value
...
*			NPD_FAILURE
********************************************************************************/
#define NPD_DBUS_METHOD_CONFIG_GVRP_TIMER  "config_global_gvrp_timer"
/*****************************************************************************
*	DESCRIPTION: 
*			This method SHOW gvrp global configuration including hold timer, join timer, leave timer, leaveall timer;
*			 NPD_DBUS_ETHPORTS_INTERFACE_METHOD_SHOW_GVRP
*
*	INPUT:
*
*  OUTPUT:  
...
*			NPD_FAILURE
********************************************************************************/
#define NPD_DBUS_METHOD_SHOW_GVRP  "show_global_gvrp"

/*****************************************************************************
*	DESCRIPTION: 
*			This method SHOW gvrp running  configuration 
*			 NPD_DBUS_METHOD_SHOW_GVRP_RUNNING_CONFIG
*
*	INPUT:
*
*  OUTPUT:  
...
#define NPD_DBUS_METHOD_SHOW_GVRP_RUNNING_CONFIG "show_gvrp_running_config"

#define NPD_PRE_MANU_TEST_BOARD  "pre_manu_test"
#define NPD_MANUFACTURE_TEST_BOARD "manufacture_test"
#define NPD_MANUFACTURE_TEST_SUBBOARD "manufacture_test_subboard"

#define NPD_DBUS_POE_OBJPATH  	"/aw/npd/poe"
#define NPD_DBUS_POE_INTERFACE "aw.npd.poe"
#define NPD_DBUS_POE_METHOD_CONFIG_GLOBAL_POE_ENDIS "config_global_poe_endis"
#define NPD_DBUS_POE_METHOD_CONFIG_PORT_POE_ENDIS "config_port_poe_endis"
#define NPD_DBUS_POE_METHOD_CONFIG_PORT_POE_MAX_POWER "config_port_poe_max_power"
#define NPD_DBUS_POE_METHOD_CONFIG_PORT_POE_PRIORITY "config_port_poe_max_priority"
#define NPD_DBUS_POE_METHOD_CONFIG_POE_POWER_MANAGE "config_poe_power_management"
#define NPD_DBUS_POE_METHOD_CONFIG_POE_INTERFACE_MODE "config_poe_interface_mode"
#define NPD_DBUS_POE_METHOD_CONFIG_PORT_POE_LEGACY_CHECK "config_port_poe_legacy_check"
#define NPD_DBUS_POE_METHOD_GET_POE_INTERFACE "get_poe_interface"
#define NPD_DBUS_POE_METHOD_POE_GET_NEXT_INTERFACE "poe_get_next_interface"
#define NPD_DBUS_POE_METHOD_POE_GET_PSE   "poe_get_pse"
#define NPD_DBUS_POE_METHOD_SHOW_POE_RUNNING_CONFIG "show_poe_running_config"
#define NPD_DBUS_POE_METHOD_CONFIG_POE_INTERFACE_POWER_MODE "config_poe_interface_power_mode"
#define NPD_DBUS_POE_METHOD_CONFIG_POE_INTERFACE_POWER_UP_MODE "config_poe_interface_power_up_mode"

/*****************************************************************************
*	for sflow
********************************************************************************/
#define NPD_DBUS_SFLOW_OBJPATH  							"/aw/npd/sflow"
#define NPD_DBUS_SFLOW_INTERFACE 							"aw.npd.sflow"
#define NPD_DBUS_SFLOW_METHOD_CONFIG_PORT_SFLOW_ENDIS 		"config_sflow_endis"
#define NPD_DBUS_SFLOW_METHOD_CONFIG_SAMPLRATE 				"config_sflow_rate"
#define NPD_DBUS_SFLOW_METHOD_CONFIG_AGENT 					"config_sflow_agent"
#define NPD_DBUS_SFLOW_METHOD_CONFIG_COLLECTOR 				"config_sflow_collector"
#define NPD_DBUS_METHOD_SHOW_SFLOW_AGT_CONFIG				"sflow_show_agent"
#define NPD_DBUS_METHOD_SHOW_SFLOW_CLT_CONFIG				"sflow_show_collector"
#define NPD_DBUS_METHOD_SHOW_SFLOW_PORT						"sflow_show_port"
#define NPD_DBUS_METHOD_SHOW_SFLOW_RUNNIG_CONFIG			"sflow_model_show_running"
#define NPD_DBUS_SFLOW_METHOD_NO_AGENT 						"no_sflow_agent"
#define NPD_DBUS_SFLOW_METHOD_NO_COLLECTOR 					"no_sflow_collector"
#define NPD_DBUS_SFLOW_METHOD_NO_PORT 						"no_sflow_port"

#define NPD_DBUS_POE_METHOD_CONFIG_POE_CREATE_TIME_RANGE "config_poe_create_time_range"
#define NPD_DBUS_POE_METHOD_CONFIG_POE_DELETE_TIME_RANGE "config_poe_delete_time_range"
#define NPD_DBUS_POE_METHOD_CONFIG_POE_ADD_TIME_RANGE "config_poe_add_time_range"
#define NPD_DBUS_POE_METHOD_CONFIG_POE_NO_TIME_INFO   "config_poe_no_time_info"
#define NPD_DBUS_POE_METHOD_CONFIG_POE_ON_TIME_DEPLOY "config_poe_on_time_deploy"
#define NPD_DBUS_POE_METHOD_SHOW_POE_TIME_RANGE       "config_poe_show_time_range"
#define NPD_DBUS_POE_METHOD_SHOW_POE_TIME_INFO        "config_poe_show_time_info"
#define NPD_DBUS_POE_METHOD_SHOW_POE_TIME_BIND_INFO   "config_poe_show_time_bind_info"
/*****************************************************************************
*	DESCRIPTION: 
*			This method config service board  slot and type 
*			 NPD_DBUS_SERVICE_BOARD_CONFIG
*
*	INPUT:
*
*  OUTPUT:  
...
*			NPD_FAILURE
********************************************************************************/
#define NPD_DBUS_SERVICE_BOARD_CONFIG "service_board_config"

/*****************************************************************************
*	DESCRIPTION: 
*			This method config service traffic 
*			 NPD_DBUS_SERVICE_TRAFFIC_CONFIG
*
*	INPUT:
*
*  OUTPUT:  
...
*			NPD_FAILURE
********************************************************************************/
#define NPD_DBUS_SERVICE_TRAFFIC_CONFIG "service_traffic_config"

/*****************************************************************************
*	DESCRIPTION: 
*			This method config service traffic recover
*			 NPD_DBUS_SERVICE_TRAFFIC_RECOVER_CONFIG
*
*	INPUT:
*
*  OUTPUT:  
...
*			NPD_FAILURE
********************************************************************************/
#define NPD_DBUS_SERVICE_TRAFFIC_RECOVER_CONFIG "service_traffic_recover_config"

/*****************************************************************************
*	DESCRIPTION: 
*			This method config service traffic recover
*			 NPD_DBUS_SERVICE_TRAFFIC_BACKUP_CONFIG
*
*	INPUT:
*
*  OUTPUT:  
...
*			NPD_FAILURE
********************************************************************************/
#define NPD_DBUS_SERVICE_TRAFFIC_BACKUP_CONFIG "service_traffic_backup_config"


/*****************************************************************************
*	DESCRIPTION: 
*			This method show service board
*			 NPD_DBUS_SERVICE_BOARD_SHOW
*
*	INPUT:
*
*  OUTPUT:  
...
*			NPD_FAILURE
********************************************************************************/
#define NPD_DBUS_SERVICE_BOARD_SHOW "service_board_show"


#define NPD_DBUS_FIREWALL_GROUP_SHOW "firewall_group_show"

/*****************************************************************************
*	DESCRIPTION: 
*			This method get bind netif index of slot
*			 NPD_DBUS_SERVICE_TRAFFIC_CONFIG
*
*	INPUT:
*
...
*			NPD_FAILURE
********************************************************************************/
#define NPD_DBUS_SERVICE_BOARD_NETIF_INDEX "service_board_netif_index"
...
*			NPD_FAILURE
********************************************************************************/
#define NPD_DBUS_SERVICE_BOARD_LOAD_BANLC_MODE "service_board_load_blanlc_mode"

/*****************************************************************************
*	DESCRIPTION: 
*			This method show  service board running
*			 NPD_DBUS_SERVICE_BOARD_METHOD_SHOW_RUNNING_CONFIG
*
*	INPUT:
*
*  OUTPUT:  
...
*			NPD_FAILURE
********************************************************************************/
#define NPD_DBUS_SERVICE_BOARD_METHOD_SHOW_RUNNING_CONFIG "service_board_show_running_config"

#define NPD_DBUS_TRACK_OBJPATH                          "/aw/npd/tracking"
#define NPD_DBUS_TRACK_INTERFACE                        "aw.npd.tracking"
#define NPD_DBUS_METHOD_TRACK_GROUP                     "man_track_group"
#define NPD_DBUS_METHOD_TRACK_GROUP_DELETE              "man_track_group_delete"
#define NPD_DBUS_METHOD_TRACK_GROUP_ADD_OBJECT          "man_track_group_add_object"
#define NPD_DBUS_METHOD_TRACK_GROUP_REMOVE_OBJECT       "man_track_group_remove_object"
#define NPD_DBUS_METHOD_TRACK_GROUP_MODE                "man_track_group_mode"
#define NPD_DBUS_METHOD_TRACK_GROUP_OBJECT_L3EXIST      "man_track_group_object_l3_exist"
#define NPD_DBUS_METHOD_TRACK_GROUP_OBJECT_L2EXIST      "man_track_group_object_l2_exist"
#define NPD_DBUS_METHOD_TRACK_GROUP_GET                 "man_track_group_get"
#define NPD_DBUS_METHOD_TRACK_GROUP_GET_NEXT            "man_track_group_get_next"
#define NPD_DBUS_METHOD_TRACK_GROUP_SHOW_RUNNING        "man_track_group_show_running"
#define NPD_DBUS_METHOD_TRACK_GROUP_STATUS              "man_track_group_status"
#define NPD_DBUS_METHOD_TRACK_GROUP_ACTION_DOWN         "man_track_group_action_down"


#define NPD_DBUS_SMART_LINK_OBJPATH                     "/aw/npd/smartlink"
#define NPD_DBUS_SMART_LINK_INTERFACE                   "aw.npd.smartlink"
#define NPD_DBUS_SMART_LINK_INFORMATION                 "sl_information"
#define NPD_DBUS_SMART_LINK_ADV_VLAN_LIST               "sl_adv_vlan_list"
#define NPD_DBUS_SMART_LINK_ADV_VLAN_LIST_GET           "sl_a_v_l_get"

#define NPD_DBUS_ASD_OBJPATH 			                "/aw/npd/asd"
#define NPD_DBUS_ASD_INTERFACE 			                "aw.npd.asd"
#define NPD_DBUS_ASD_SET_PORTAL_CLIENT_BYPASS           "acl_set_portal_client_bypass"
#define NPD_DBUS_ASD_SHOW_PORTAL_CLIENT_BYPASS          "acl_show_portal_client_bypass"
#define NPD_DBUS_ASD_PORTAL_SHOWRUNNING                 "portal_showrunning"

#define NPD_DBUS_METHOD_IP_TUNNEL                      "npd_ip_tnl"
#define NPD_DBUS_METHOD_NO_IP_TUNNEL                   "npd_no_ip_tnl"
#define NPD_DBUS_METHOD_TUNNEL_IPV6_ADDRESS            "npd_tnl_in6"
#define NPD_DBUS_METHOD_TUNNEL_NO_IPV6_ADDRESS         "npd_tnl_no_in6"
#define NPD_DBUS_METHOD_TUNNEL_SOURCE                  "npd_tnl_src4"
#define NPD_DBUS_METHOD_TUNNEL_DESTINATION             "npd_tnl_dst4"
#define NPD_DBUS_METHOD_TUNNEL_MODE                    "npd_tnl_mode"
#define NPD_DBUS_METHOD_TUNNEL_SHOW_ID                 "npd_tnl_show_id"
#define NPD_DBUS_METHOD_TUNNEL_SHOW_NEXT               "npd_tnl_show_next"
#define NPD_DBUS_METHOD_TUNNEL_SHOW_RUN                "npd_tnl_show_run"

#define NPD_DBUS_METHOD_INTERFACE_TUNNEL               "npd_if_tnl"
#define NPD_DBUS_METHOD_NO_INTERFACE_TUNNEL            "npd_no_if_tnl"
