...
#include "as2k_3200_9gc_pwr_led_code.c"

long as2k_3200_9gc_pwr_sfp_online(unsigned long panel_port)
{
    return NPD_SUCCESS;
}

long as2k_3200_9gc_pwr_sfp_detect_start()
{
    return NPD_SUCCESS;    
}

long as2k_3200_9gc_pwr_sfp_info_get(unsigned long panel_port, fiber_module_man_param_t *param)
{
    return NPD_SUCCESS;
}

long as2k_3200_9gc_pwr_slotno_get()
{
    return 0;
}

long as2k_3200_9gc_pwr_local_reset()
{
    npd_syslog_err("NH MCU local reset not be supported.\n");
    return NPD_SUCCESS;
}

long as2k_3200_9gc_pwr_reset_type()
{
...
unsigned  as2k_3200_9gc_pwr_thread_fan_led_light(void *arg)
{
	...
	fan_present = as2k_3200_fan_present(0x04, I2C_LPT_SADDR3, I2C_LPT_3);
	...
	as2k_3200_fan_led_light(0x00,0x10,0x10,0xEC,
...
unsigned  as2k_3200_9gc_pwr_thread_power_led_light(void *arg)
{
	...
	as2k_3200_power_led_light(0x00,0x10, 0x30, 0x30, 0xCC,
...
long as2k_3200_9gc_pwr_led_lighting(unsigned long status)
{
    return NPD_SUCCESS;
}

long as2k_3200_9gc_pwr_pne_mon_start()
{
	//as2k_3200_28gc_pwr_fan_led_light();
    nam_thread_create("fan_led_lighting",
		as2k_3200_9gc_pwr_thread_fan_led_light, NULL,NPD_TRUE, NPD_FALSE);
	
    nam_thread_create("power_led_lighting", 
		as2k_3200_9gc_pwr_thread_power_led_light, NULL,NPD_TRUE, NPD_FALSE);
	
	as2k_start_pne_monitor();
    return NPD_SUCCESS;
}

long as2k_3200_9gc_pwr_mnparam_get(board_man_param_t *info)
{
...
long as2k_3200_9gc_pwr_sal_config_init_defaults(void)
{
...
long as2k_3200_9gc_pwr_poe_init()
{
	char* filename ;
	...
	*/
	...
	{
		printf("AS3209GC_PWR init poe open console failed.\n");
		npd_syslog_dbg("AS3209GC_PWR init poe open console failed.\n");
		return NPD_FAIL;
	}

	if (fcntl(console_fd, F_SETFL, 0) < 0) 
	{
		printf("AS3209GC_PWR init poe fcntrl F_SETFL failed.\n");
		npd_syslog_dbg("AS3209GC_PWR init poe fcntrl F_SETFL failed.\n");
		return NPD_FAIL;
	}
	int ret = 0;
	if ((ret = as2k_3200_set_com_config(console_fd, 19200, 8, 'N', 1)) < 0)
	{
		printf("AS3209GC_PWR init poe set_com_config failed.\n");
		npd_syslog_dbg("AS3209GC_PWR init poe set_com_config failed.\n");
		return NPD_FAIL;			
	}
...
long as2k_3200_9gc_pwr_poe_operate(void *in_data, void *out_data)
{
	int buf_len = 12;
	int i = 0;
	int len=0;
	...
	{
		printf("AS3209GC_PWR init poe write console error.\n");
		npd_syslog_dbg("AS3209GC_PWR init poe write console error.\n");
		return -1;		
	}
...
*/
	...
	if (0 != remain_length)
	{
		printf("AS3209GC_PWR init poe read console error.\n");
		npd_syslog_dbg("AS3209GC_PWR init poe read console error.\n");
		return -1;	
	}
	...
	if (sum != response_buf[11])
	{
		...
		printf("AS3209GC_PWR init poe read data checksum error.\n");
		npd_syslog_dbg("AS3209GC_PWR init poe read data checksum error.\n");
		return NPD_FAIL;
	}
...
long as2k_3200_9gc_pwr_i2c_sfp_operate(int unit, char * devName, int addr)
{
	int fd = 0;
...
long as2k_3200_9gc_pwr_asic_led_proc(int unit)
{
    npd_syslog_dbg("AS3209GC_PWR led code for unit %d loading.\n", unit);
	as2k_3200_i2c_sfp_operate(0x00, 0x02, 0x02, 0xFD, I2C_LPT_0, I2C_LPT_SADDR0, 1);
	//as2k_3200_9gc_pwr_i2c_sfp_operate(unit, I2C_LPT_0, I2C_LPT_SADDR0);
	as2k_3200_9gc_pwr_pne_mon_start();

	return soc_ledproc_config(unit, ledproc_as3200_9gc_pwr, sizeof(ledproc_as3200_9gc_pwr));
}

ipp_fix_param_t  as2k_3200_9gc_pwr_ipp_param =
{
    .ipp_portnum = 1,
...
sub_board_fix_param_t as2k_3200_9gc_pwr_subboard_param = 
{
    .sub_slotnum = 1,     // more than 1
    .sub_slot_portnum = 0
};
poe_module_fix_param_t  as2k_3200_9gc_pwr_poe_param = 
{
	.poe_ports = {0xff,0},
	.pse_total_power = 1250,
	.pse_guard_band = 200,
	.pse_mpss = 1,
	.pse_type = PSE_IEEE_POEPLUS,
	.poe_init = &as2k_3200_9gc_pwr_poe_init,
	.poe_operate = &as2k_3200_9gc_pwr_poe_operate,
};
fiber_module_fix_param_t as2k_3200_9gc_pwr_sfp_param =
{
    .fiber_module_inserted = &as2k_3200_9gc_pwr_sfp_online,
    .fiber_module_insert_detect = &as2k_3200_9gc_pwr_sfp_detect_start,
    .fiber_module_info_get = &as2k_3200_9gc_pwr_sfp_info_get,
};

ams_fix_param_t as2k_3200_9gc_pwr_asic_switch =
{
    ...
    .ams_led_proc = &as2k_3200_9gc_pwr_asic_led_proc,
    .ams_enable = NULL,
};

ams_fix_param_t as2k_3200_9gc_pwr_ctrl_switch = 
{
...
temper_fix_param_t as2k_3200_9gc_pwr_temper_param =
{
    .num = 0,
};

board_feature_t as2k_3200_9gc_pwr_feature = 
{
    .jumbo_size = 13000,
    .max_macaddr = 8192,
    .max_macapp = 512,
...
int as2k_3200_9gc_pwr_support_product[] =
{
    PRODUCT_AS2K_3200,
    0
};

board_fix_param_t as2k_3200_9gc_pwr_param =
{
    .board_code = PPAL_BOARD_HWCODE_AS2K_3209GC_PWR,
    .board_type = PPAL_BOARD_TYPE_AS2K_3209,
    .full_name = "AS3209 Power Smart Switch",
    .short_name = "AS3200-9GS-PWR",
    ...
    .subboard_fix_param = &as2k_3200_9gc_pwr_subboard_param,
    .ipp_fix_param = &as2k_3200_9gc_pwr_ipp_param,
    .temper_fix_param = &as2k_3200_9gc_pwr_temper_param,
    .feature = &as2k_3200_9gc_pwr_feature,
    .sdk_type = SDK_BCM,
    .board_support_product = (int*)as2k_3200_9gc_pwr_support_product
    
};

board_spec_fix_param_t as2k_3200_9gc_pwr_spec_param =
{
    .board_type = PPAL_BOARD_TYPE_AS2K_3209,
    .fiber_module_fix_param = &as2k_3200_9gc_pwr_sfp_param,
	.poe_module_fix_param = &as2k_3200_9gc_pwr_poe_param,
    .ams_param = {
                    [0] = &as2k_3200_9gc_pwr_asic_switch
                 },

    .slotno_get = &as2k_3200_9gc_pwr_slotno_get,
    .reset = &as2k_3200_9gc_pwr_local_reset,
    .get_reset_type = &as2k_3200_9gc_pwr_reset_type,
    .sys_led_lighting = NULL,
    .pne_monitor_start = as2k_3200_9gc_pwr_pne_mon_start,
    .board_man_param_get = &as2k_3200_9gc_pwr_mnparam_get,
    .local_conn_init = &as2k_3200_local_conn_init,
    .system_conn_init = &as2k_3200_system_conn_init,
    .asic_config_init = &as2k_3200_9gc_pwr_sal_config_init_defaults,
};
