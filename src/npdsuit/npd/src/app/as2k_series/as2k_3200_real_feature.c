...
long as2k_3200_real_board_online(unsigned long slot_index)
{
    return 1;
}

long as2k_3200_real_load_backinfo(product_man_param_t *param)
{
    npd_syslog_dbg("Get product sys info\n --%s", __FUNCTION__);
	
    param->basemac = (char*)base_mac;
    param->sn = "1001";
    param->name = "AuteS 3200";
...
long as2k_3200_real_slotno_get()
{
    return 0;
}

void as2k_3200_real_npd_master_set()
{
	return;
}

board_manage_fix_param_t as2k_3200_real_boardmn_fix_param =
{
    .slotnum = 1,
    .master_slotnum = 1,
    .master_slot_id = {0},
    ...
    .board_inserted = &as2k_3200_real_board_online,
...
pne_fix_param_t as2k_3200_real_pne_fix_param = 
{
    .power_num = 1,
    .fan_num = 1,
...
product_feature_t as2k_3200_real_feature = 
{
    .jumbo_size = 13000,
    .max_macaddr = 8192,
    .max_macapp = 512,
...
product_fix_param_t as2k_3200_real_fix_param =
{
    .product_code = PPAL_PRODUCT_HWCODE_AS2K_3200,
    .product_type = PRODUCT_AS2K_3200,
    .product_short_name = "AS3200",
    .product_name = "AuteS 3200 L2 PLUS Ethernet Switch",
    .product_pp_feature = &as2k_3200_real_feature,
    .serial_no = "1001",
    .board_manage = &as2k_3200_real_boardmn_fix_param,
    .pne_fix_param_t = &as2k_3200_real_pne_fix_param,
    .product_man_param_get = &as2k_3200_real_load_backinfo,
    .product_reset = &as2k_sys_reset,
    .product_show_chassis = &as2k_chassis_show,
    .slotno_get = &as2k_3200_real_slotno_get,
    .master_set = &as2k_3200_real_npd_master_set
};
