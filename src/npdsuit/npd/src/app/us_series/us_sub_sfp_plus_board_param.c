...
long us_sub_sfp_plus_board_npd_os_upgrade(unsigned int slot_index)
{
	npd_syslog_err("NH us4628pwr not be supported.\n");
	return NPD_SUCCESS;
}

ipp_fix_param_t  us_sub_sfp_plus_board_ipp_param =
{
    .ipp_portnum = 1,
...
int sub_sfp_plus_slot_man_param_get(unsigned int slot_index,   board_man_param_t *man_param)
{
	   man_param->id = PPAL_HWCODE_US_SUB_SFP_PLUS;
	  sprintf(man_param->modname, "AUX4601");
      return 0;
}

sub_board_fix_param_t us_sub_sfp_plus_board_subboard_param = 
{
...
temper_fix_param_t us_sub_sfp_plus_board_temper_param =
{
    .num = 0,
};

board_feature_t us_sub_sfp_plus_board_feature = 
{
    .jumbo_size = 16384,
    .max_macaddr = 16384,
    .max_macapp = 512,
...
int us_sub_sfp_plus_board_support_product[] =
{
    PRODUCT_US3000,
    0
};
...
board_fix_param_t us_sub_sfp_plus_board_param =
{
    .board_code = PPAL_HWCODE_US_SUB_SFP_PLUS,
    .board_type = PPAL_BOARD_TYPE_US_SUB_SFP_PLUS,
    .full_name = "AUX4601 BOARD",
    .short_name = "AUX4601",
    .have_pp = TRUE,
    .master_flag = FALSE,
    .service_flag = TRUE,
    .panel_portnum = 1,
    .subboard_fix_param = &us_sub_sfp_plus_board_subboard_param,
    .ipp_fix_param = &us_sub_sfp_plus_board_ipp_param,
    .temper_fix_param = &us_sub_sfp_plus_board_temper_param,
    .os_upgrade = &us_sub_sfp_plus_board_npd_os_upgrade,
    .feature = &us_sub_sfp_plus_board_feature,
    .sdk_type = SDK_ATHEROS,
    .board_support_product = (int *)us_sub_sfp_plus_board_support_product,
