...
long us_sub_4sfp_board_npd_os_upgrade(unsigned int slot_index)
{
	npd_syslog_err("NH us4628pwr not be supported.\n");
	return NPD_SUCCESS;
}

ipp_fix_param_t  us_sub_4sfp_board_ipp_param =
{
    .ipp_portnum = 1,
...
long sub_4sfp_slot_man_param_get(unsigned int slot_index,   board_man_param_t *man_param)
{
	man_param->id = PPAL_HWCODE_US_SUB_4SFP;
	sprintf(man_param, "AUG4604S");
	return 0;
}

int sub_4sfp_slot_support(int product_type, int slot, int subslot)
{
	if(subslot == 1)
		return TRUE;
	else
...
sub_board_fix_param_t us_sub_4sfp_board_subboard_param = 
{
    .sub_slotnum = 1,     // more than 1
    .sub_slot_portnum = 0,
    .sub_slot_man_param_get  = sub_4sfp_slot_man_param_get
};

temper_fix_param_t us_sub_4sfp_board_temper_param =
{
    .num = 0,
};

board_feature_t us_sub_4sfp_board_feature = 
{
    .jumbo_size = 16384,
    .max_macaddr = 16384,
    .max_macapp = 512,
...
int us_sub_4sfp_board_support_product[] =
{
    PRODUCT_US3000,
    0
};
...
board_fix_param_t us_sub_4sfp_board_param =
{
    .board_code = PPAL_HWCODE_US_SUB_4SFP,
    .board_type = PPAL_BOARD_TYPE_US_SUB_4SFP,
    .full_name = "AUG4604S BOARD",
    .short_name = "AUG4604S",
    .have_pp = TRUE,
    .master_flag = FALSE,
    .service_flag = TRUE,
    .panel_portnum = 4,
    .subboard_fix_param = &us_sub_4sfp_board_subboard_param,
    .ipp_fix_param = &us_sub_4sfp_board_ipp_param,
    .temper_fix_param = &us_sub_4sfp_board_temper_param,
    .os_upgrade = &us_sub_4sfp_board_npd_os_upgrade,
    .feature = &us_sub_4sfp_board_feature,
    .sdk_type = SDK_ATHEROS,
    .board_support_product = (int *)us_sub_4sfp_board_support_product,
    .board_support_slot = sub_4sfp_slot_support,
};
