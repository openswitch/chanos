...
long us3000_board_npd_os_upgrade(unsigned int slot_index)
{
	npd_syslog_err("NH 3052 not be supported.\n");
	return NPD_SUCCESS;
}

ipp_fix_param_t  us3000_board_ipp_param =
{
    .ipp_portnum = 1,
...
sub_board_fix_param_t us3000_board_subboard_param = 
{
    .sub_slotnum = 1,     // more than 1
    .sub_slot_portnum = 0
};

temper_fix_param_t us3000_board_temper_param =
{
    .num = 0,
};

board_feature_t us3000_board_feature = 
{
    .jumbo_size = 16384,
    .max_macaddr = 16384,
    .max_macapp = 512,
...
int us3000_board_support_product[] =
{
    PRODUCT_US3000,
    0
};
...
board_fix_param_t us3000_board_param =
{
    .board_code = PPAL_HWCODE_US_3000,
    .board_type = PPAL_BOARD_TYPE_US_3000,
    .full_name = US3000_FULL_NAME,
    .short_name = US3000_SHORT_NAME,
    .have_pp = TRUE,
    .master_flag = FALSE,
    .service_flag = TRUE,
    .panel_portnum = 24,
    .subboard_fix_param = &us3000_board_subboard_param,
    .ipp_fix_param = &us3000_board_ipp_param,
    .temper_fix_param = &us3000_board_temper_param,
    .os_upgrade = &us3000_board_npd_os_upgrade,
    .feature = &us3000_board_feature,
    .sdk_type = SDK_ATHEROS,
    .board_support_product = (int *)us3000_board_support_product,
