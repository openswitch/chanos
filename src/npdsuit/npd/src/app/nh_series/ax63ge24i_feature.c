...
long ax63ge24i_local_conn_init(int product_type)
{
    return as_series_linecard_local_conn_init(product_type);
}

long ax63ge24i_system_conn_init(
    int product_type, 
...
long ax63ge24i_system_conn_deinit(
    int product_type, 
    int del_board_type, 
    int del_slotid    
    )
...
board_spec_fix_param_t ax63ge24i_spec_param =
{
