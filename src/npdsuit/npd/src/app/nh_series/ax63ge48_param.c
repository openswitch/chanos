...
long ax63ge48_npd_os_upgrade(unsigned int slot_index)
{
	return chasm_os_upgrade(slot_index);
}

long ax63ge48_board_ready_config(unsigned int slot_index)
{
	return chasm_board_ready_config(slot_index);
}


ipp_fix_param_t  ax63ge48_ipp_param =
{
    .ipp_portnum = 2,
...
sub_board_fix_param_t ax63ge48_subboard_param = 
{
    .sub_slotnum = 1,     // more than 1
    .sub_slot_portnum = 0
};

temper_fix_param_t ax63ge48_temper_param =
{
    .num = 2,
...
{
    .board_code = PPAL_BOARD_HWCODE_AX63GE48,
    .board_type = PPAL_BOARD_TYPE_AX63GE48,
    .full_name = "AUTELAN AS6600 SERIES MULTI-LAYER SWITCH 48 10/100/1000BASE-TX ENANCED BOARD",
    .short_name = "ASG6648",
    .have_pp = TRUE,
    .master_flag = FALSE,
    .service_flag = FALSE,
    .panel_portnum = 48,
    .ipp_fix_param = &ax63ge48_ipp_param,
    .subboard_fix_param = &ax63ge48_subboard_param,
    .temper_fix_param = &ax63ge48_temper_param,
    .os_upgrade = &ax63ge48_npd_os_upgrade,
    .board_ready_config = &ax63ge48_board_ready_config,
    .feature = &ax63ge48_feature,
    .sdk_type = SDK_MARVELL,
    .board_support_product = (int*)ax63ge48_support_product
};
