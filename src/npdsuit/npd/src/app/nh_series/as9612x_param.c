...
{
#endif
long as9612x_os_upgrade(unsigned int slot_index)
{
	return nh_os_upgrade(slot_index);
}

long as9612x_board_ready_config(unsigned int slot_index)
{
	return chasm_board_ready_config(slot_index);
}

ipp_fix_param_t  as9612x_ipp_param =
{
    .ipp_portnum = 1,
...
sub_board_fix_param_t as9612x_subboard_param = 
{
    .sub_slotnum = 1,     // more than 1
    .sub_slot_portnum = 0
};

temper_fix_param_t as9612x_temper_param =
{
    .num = 0,
    .name = {"OCTEON TEMP", "HUMBER TEMP"}
};

board_feature_t as9612x_feature = 
{
    .jumbo_size = 13000,
    .max_macaddr = 32768,
    .max_macapp = 512,
    ...
    .max_vlanswitch_ingress = 4096,
    .max_vlanswitch_egress = 4096,
    .max_qinq = 4096,
...
board_fix_param_t as9612x_param =
{
    .board_code = PPAL_BOARD_HWCODE_AS9612X,
    .board_type = PPAL_BOARD_TYPE_AS9612X,
    .full_name = "AUTELAN AS SERIES MULTI-LAYER SWITCH 12x10G BOARD",
    .short_name = "ASX9612",
    .have_pp = TRUE,
    .master_flag = FALSE,
    .service_flag = FALSE,
    .panel_portnum = 12,
    .subboard_fix_param = &as9612x_subboard_param,
    .ipp_fix_param = &as9612x_ipp_param,
    .temper_fix_param = &as9612x_temper_param,
    .os_upgrade = &as9612x_os_upgrade,
    .board_ready_config = &as9612x_board_ready_config,
    .feature = &as9612x_feature,
    .sdk_type = SDK_MARVELL,
    .board_support_product = (int*)as9612x_support_product
};
