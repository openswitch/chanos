...
void g9006_int_linecard_handler(unsigned char int_value, unsigned char add_value)
{
	//print
	...
	npd_syslog_dbg("Enter g9006_int_linecard_handler.\n");
...
void g9006_int_chasis_state_handler(unsigned char int_value, unsigned char add_value)
{
...
void g9006_int_switch_master_handler(unsigned char int_value, unsigned char add_value)
{
...
npd_int_ctrl g9006_npd_int_proc_arr[] =
{
	{0, 8, 	g9006_int_linecard_handler},
	{1, 9, 	g9006_int_chasis_state_handler},
	{2, 10, t9000_int_power_handler},		
	{1, 11, g9006_int_switch_master_handler}, /* this int is special.  */
};


void g9006_npd_interrupt_handler(void)
{
	int ret = 0;
	...
	for(index = 0; index < LENGTH(g9006_npd_int_proc_arr); index++)
	{
		npd_int_ctrl = &g9006_npd_int_proc_arr[index];
...
board_manage_fix_param_t g9006_boardmn_fix_param =
{
    .slotnum = 6,
    .master_slotnum = 2,
    .master_slot_id = {2, 3},
...
pne_fix_param_t g9006_pne_fix_param = 
{
    .power_num = 2,  
    .fan_num = 1,
...
product_feature_t g9006_feature = 
{
    .jumbo_size = 13000,
    .max_macaddr = 32768,
    .max_macapp = 512,
...
product_fix_param_t g9006_fix_param =
{
    .product_code = PPAL_PRODUCT_HWCODE_G9606,
    .product_type = PRODUCT_G9606,
    .product_short_name = G9606_SHORT_NAME,
    .product_name = G9606_FULL_NAME,
    .product_pp_feature = &g9006_feature,
    .serial_no = "9000",
    .board_manage = &g9006_boardmn_fix_param,
    .pne_fix_param_t = &g9006_pne_fix_param,
    ...
    .interrupt_handler = &g9006_npd_interrupt_handler,
