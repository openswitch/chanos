...
{
#endif
long cgm9048_os_upgrade(unsigned int slot_index)
{
	return nh_os_upgrade(slot_index);
}

long cgm9048_board_ready_config(unsigned int slot_index)
{
	return chasm_board_ready_config(slot_index);
}

ipp_fix_param_t  cgm9048_ipp_param =
{
    .ipp_portnum = 1,
...
sub_board_fix_param_t cgm9048_subboard_param = 
{
    .sub_slotnum = 1,     // more than 1
    .sub_slot_portnum = 0
};

temper_fix_param_t cgm9048_temper_param =
{
    .num = 2,
    .name = {"OCTEON TEMP", "HUMBER TEMP"}
};

board_feature_t cgm9048_feature = 
{
    .jumbo_size = 13000,
    .max_macaddr = 32768,
    .max_macapp = 512,
...
board_fix_param_t cgm9048_param =
{
    .board_code = PPAL_BOARD_HWCODE_CGM9048,
    ...
    .service_flag = FALSE,
    .panel_portnum = 48,
    .subboard_fix_param = &cgm9048_subboard_param,
    .ipp_fix_param = &cgm9048_ipp_param,
    .temper_fix_param = &cgm9048_temper_param,
    .os_upgrade = &cgm9048_os_upgrade,
    .board_ready_config = &cgm9048_board_ready_config,
    .feature = &cgm9048_feature,
    .sdk_type = SDK_BCM,
    .board_support_product = (int*)cgm9048_support_product
};
