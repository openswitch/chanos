...
void t9010_int_linecard_handler(unsigned char int_value, unsigned char add_value)
{
	//print
	...
	npd_syslog_dbg("Enter t9010_int_linecard_handler.\n");
...
void t9010_int_chasis_state_handler(unsigned char int_value, unsigned char add_value)
{
...
void t9010_int_switch_master_handler(unsigned char int_value, unsigned char add_value)
{
...
void t9010_int_power_handler(unsigned char int_value, unsigned char add_value)
{
	...
	npd_syslog_dbg("Enter t9010_int_power_handler.\n"); 
...
npd_int_ctrl t9010_npd_int_proc_arr[] =
{
	{0, 8, 	t9010_int_linecard_handler},
	{1, 9, 	t9010_int_chasis_state_handler},
	{2, 10, t9000_int_power_handler},				
	{1, 11, t9010_int_switch_master_handler}, /* this int is special.  */
};


void t9010_npd_interrupt_handler(void)
{
	int ret = 0;
	...
	for(index = 0; index < LENGTH(t9010_npd_int_proc_arr); index++)
	{
		npd_int_ctrl = &t9010_npd_int_proc_arr[index];
...
board_manage_fix_param_t t9010_boardmn_fix_param =
{
    .slotnum = 10,
    .master_slotnum = 2,
    .master_slot_id = {4, 5},
...
pne_fix_param_t t9010_pne_fix_param = 
{
    .power_num = 4, 
    .fan_num = 1,
...
product_feature_t t9010_feature = 
{
    .jumbo_size = 13000,
    .max_macaddr = 32768,  
    .max_macapp = 512,
...
product_fix_param_t t9010_fix_param =
{
    .product_code = PPAL_PRODUCT_HWCODE_T9010,
    .product_type = PRODUCT_T9010,
    .product_short_name = T9010_SHORT_NAME,
    .product_name = T9010_FULL_NAME,
    .product_pp_feature = &t9010_feature,
    .serial_no = "2000",
    .board_manage = &t9010_boardmn_fix_param,
    .pne_fix_param_t = &t9010_pne_fix_param,
    ...
    .interrupt_handler = &t9010_npd_interrupt_handler,
