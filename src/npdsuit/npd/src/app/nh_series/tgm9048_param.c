...
long tgm9048_npd_os_upgrade(unsigned int slot_index)
{
	return nh_os_upgrade(slot_index);
}

long tgm9048_board_ready_config(unsigned int slot_index)
{
	return chasm_board_ready_config(slot_index);
}

ipp_fix_param_t  tgm9048_ipp_param =
{
    .ipp_portnum = 2,
...
sub_board_fix_param_t tgm9048_subboard_param = 
{
    .sub_slotnum = 1,     // more than 1
    .sub_slot_portnum = 0
};

temper_fix_param_t tgm9048_temper_param =
{
    .num = 2,
    .name = {"OCTEON TEMP", "BCM 56820 TEMP"}
};

board_feature_t tgm9048_feature = 
{
    .jumbo_size = 13000,
    .max_macaddr = 32768,
    .max_macapp = 512,
...
board_fix_param_t tgm9048_param =
{
    .board_code = PPAL_BOARD_HWCODE_TGM9048,
    .board_type = PPAL_BOARD_TYPE_TGM9048,
    .full_name = "AUTELAN AS9600 SERIES MULTI-LAYER SWITCH 48 10/100/1000BASE-TX BOARD",
    .short_name = "ASG9648",
    .have_pp = TRUE,
    .master_flag = FALSE,
    .service_flag = FALSE,
    .panel_portnum = 48,
    .subboard_fix_param = &tgm9048_subboard_param,
    .ipp_fix_param = &tgm9048_ipp_param,
    .temper_fix_param = &tgm9048_temper_param,
    .os_upgrade = &tgm9048_npd_os_upgrade,  
    .board_ready_config = &tgm9048_board_ready_config,
    .feature = &tgm9048_feature,
    .sdk_type = SDK_BCM,
    .board_support_product = (int*)tgm9048_support_product
};
