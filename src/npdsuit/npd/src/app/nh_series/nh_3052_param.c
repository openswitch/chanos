...
long nh_3052_npd_os_upgrade(unsigned int slot_index)
{
	npd_syslog_err("NH 3052 not be supported.\n");
	return nh_os_upgrade(slot_index);
}

ipp_fix_param_t  nh_31msb_ipp_param =
{
    .ipp_portnum = 1,
...
sub_board_fix_param_t nh_31msb_subboard_param = 
{
    .sub_slotnum = 1,     // more than 1
    .sub_slot_portnum = 0
};

temper_fix_param_t nh_31msb_temper_param =
{
    .num = 0,
};

board_feature_t nh_31msb_feature = 
{
    .jumbo_size = 13000,
    .max_macaddr = 32768,
    .max_macapp = 512,
...
int nh_31msb_support_product[] =
{
	PRODUCT_NH_3052,
	0
};

board_fix_param_t nh_31msb_param =
{
    .board_code = PPAL_HWCODE_NH_3052,
    .board_type = PPAL_BOARD_TYPE_NH_3052,
    .full_name = "AU3052 BOARD",
    .short_name = "AU3052",
    .have_pp = TRUE,
    .master_flag = FALSE,
    .service_flag = TRUE,
    .panel_portnum = 52,
    .subboard_fix_param = &nh_31msb_subboard_param,
    .ipp_fix_param = &nh_31msb_ipp_param,
    .temper_fix_param = &nh_31msb_temper_param,
    .os_upgrade = &nh_3052_npd_os_upgrade,
    .feature = &nh_31msb_feature,
	.sdk_type = SDK_BCM,
    .board_support_product = (int*)nh_31msb_support_product
};
