...
{
#endif
long cgm9048s_os_upgrade(unsigned int slot_index)
{
	return nh_os_upgrade(slot_index);
}

long cgm9048s_board_ready_config(unsigned int slot_index)
{
	return chasm_board_ready_config(slot_index);
}

ipp_fix_param_t  cgm9048s_ipp_param =
{
    .ipp_portnum = 1,
...
sub_board_fix_param_t cgm9048s_subboard_param = 
{
    .sub_slotnum = 1,     // more than 1
    .sub_slot_portnum = 0
};

temper_fix_param_t cgm9048s_temper_param =
{
    .num = 2,
    .name = {"OCTEON TEMP", "HUMBER TEMP"}
};

board_feature_t cgm9048s_feature = 
{
    .jumbo_size = 13000,
    .max_macaddr = 32768,
    .max_macapp = 512,
...
board_fix_param_t cgm9048s_param =
{
    .board_code = PPAL_BOARD_HWCODE_CGM9048S,
    .board_type = PPAL_BOARD_TYPE_CGM9048S,
    .full_name = "SafeGuard Series MULTI-LAYER SWITCH 48 10/100/1000BASE-TX BOARD",
    .short_name = "G96-48S",
    .have_pp = TRUE,
    .master_flag = FALSE,
    .service_flag = FALSE,
    .panel_portnum = 48,
    .subboard_fix_param = &cgm9048s_subboard_param,
    .ipp_fix_param = &cgm9048s_ipp_param,
    .temper_fix_param = &cgm9048s_temper_param,
    .os_upgrade = &cgm9048s_os_upgrade,
    .board_ready_config = &cgm9048s_board_ready_config,
    .feature = &cgm9048s_feature,
    .sdk_type = SDK_BCM,
    .board_support_product = (int*)cgm9048s_support_product
};
