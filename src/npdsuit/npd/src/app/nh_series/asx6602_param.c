...
long asx6602_npd_os_upgrade(unsigned int slot_index)
{
	return nh_os_upgrade(slot_index);
}

sub_board_fix_param_t asx6602_subboard_param = 
{
    .sub_slotnum = 1,     // more than 1
    .sub_slot_portnum = 0
};

board_feature_t asx6602_feature = 
{
    .jumbo_size = 13000,
    .max_macaddr = 16384,
    .max_macapp = 0,
...
board_fix_param_t asx6602_param =
{
    .board_code = PPAL_BOARD_HWCODE_ASX6602,
    .board_type = PPAL_BOARD_TYPE_ASX6602,
    .full_name = "AUTELAN AS6600 SERIES MULTI-LAYER SWITCH 2x10G BOARD",
    .short_name = "ASX6602",
    .have_pp = FALSE,
    .master_flag = FALSE,
    .service_flag = FALSE,
    .panel_portnum = 2,
    .subboard_fix_param = &asx6602_subboard_param,
    .ipp_fix_param = NULL,
    .temper_fix_param = NULL,
    .os_upgrade = asx6602_npd_os_upgrade,    
    .feature = &asx6602_feature,
    .sdk_type = SDK_MARVELL,
    .board_support_product = (int*)asx6602_support_product
};
