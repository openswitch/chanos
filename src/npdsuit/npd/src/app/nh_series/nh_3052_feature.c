...
long nh_3052_board_online(int slot_index)
{
    return TRUE;
}

long nh3052_load_backinfo(product_man_param_t *param)
{
...
void nh3052_npd_master_set(unsigned long value)
{
	return;
}

board_manage_fix_param_t nh3052_boardmn_fix_param =
{
    .slotnum = 6,
    .master_slotnum = 2,
    .master_slot_id = {2,3},
    ...
    .board_inserted = &nh_3052_board_online,
...
pne_fix_param_t nh3052_pne_fix_param = 
{
    .power_num = 2,
    .fan_num = 1,
...
product_feature_t nh3052_feature = 
{
    .jumbo_size = 13000,
    .max_macaddr = 16384,
    .max_macapp = 512,
...
product_fix_param_t nh3052_fix_param =
{
    .product_code = PPAL_PRODUCT_HWCODE_NH3052,
    .product_type = PRODUCT_NH_3052,
    .product_short_name = NH3052_SHORT_NAME,
    .product_name = "",
    .product_pp_feature = &nh3052_feature,
    .serial_no = "1001",
    .board_manage = &nh3052_boardmn_fix_param,
    .pne_fix_param_t = &nh3052_pne_fix_param,
    .product_man_param_get = &nh3052_load_backinfo,
    .product_reset = &nh_sys_reset,
    .product_show_chassis = &nh_chassis_show,
    .slotno_get = &nh3052_slotno_get,
    .master_set = &nh3052_npd_master_set
};
