...
long txm9004_npd_os_upgrade(unsigned int slot_index)
{
	return nh_os_upgrade(slot_index);
}

long txm9004_board_ready_config(unsigned int slot_index)
{
	return chasm_board_ready_config(slot_index);
}

ipp_fix_param_t  txm9004_ipp_param =
{
    .ipp_portnum = 2,
...
sub_board_fix_param_t txm9004_subboard_param = 
{
    .sub_slotnum = 1,     // more than 1
    .sub_slot_portnum = 0
};

temper_fix_param_t txm9004_temper_param =
{
    .num = 2,
    .name = {"OCTEON TEMP", "BCM 56320 TEMP"}
};

board_feature_t txm9004_feature = 
{
    .jumbo_size = 13000,
    .max_macaddr = 32768,
    .max_macapp = 512,
...
board_fix_param_t txm9004_param =
{
    .board_code = PPAL_BOARD_HWCODE_TXM9004,
    .board_type = PPAL_BOARD_TYPE_TXM9004,
    .full_name = "AUTELAN AS9600 SERIES MULTI-LAYER SWITCH 4XGESFPPLUS BOARD",
    .short_name = "ASX9604",
    .have_pp = TRUE,
    .master_flag = FALSE,
    .service_flag = FALSE,
    .panel_portnum = 4,
    .subboard_fix_param = &txm9004_subboard_param,
    .ipp_fix_param = &txm9004_ipp_param,
    .temper_fix_param = &txm9004_temper_param,
    .os_upgrade = &txm9004_npd_os_upgrade,
    .board_ready_config = &txm9004_board_ready_config,
    .feature = &txm9004_feature,
    .sdk_type = SDK_BCM,
    .board_support_product = (int*)txm9004_support_product
};
