...
long g96sup_upgrade_thread(void *arg)
{
	...
	npd_syslog_err("G96SUP not supported.\n");
	memset(cmd, 0, 300);
...
long g96sup_npd_os_upgrade(unsigned int slot_index)
{
	...
	nam_thread_create(thread_name,
		(void *)g96sup_upgrade_thread, (void *)slot_index,NPD_TRUE,NPD_FALSE);
	
	return NPD_SUCCESS;
}

long g96sup_board_ready_config(unsigned int slot_index)
{	
	return NPD_SUCCESS;
}

ipp_fix_param_t  g96sup_ipp_param =
{
    .ipp_portnum = 1,
    .ipp_phyport_map = {"eth0"},
    .ipp_board_map = {-1, -2}
};

sub_board_fix_param_t g96sup_subboard_param = 
{
    .sub_slotnum = 1,     // more than 1
    .sub_slot_portnum = 0
};

temper_fix_param_t g96sup_temper_param =
{
    .num = 2,
    .name = {"OCTEON TEMP", "BCM 56821 TEMP"}
};

board_feature_t g96sup_feature = 
{
    .jumbo_size = 13000,
    .max_macaddr = 32768,
    .max_macapp = 512,
...
board_fix_param_t g96sup_param =
{
    .board_code = PPAL_BOARD_HWCODE_TSM9002_LOONGSON,
    .board_type = PPAL_BOARD_TYPE_G96SUP,
    .full_name = "AUTELAN G96 SERIES MULTI-LAYER SWITCH MAIN CONTROL BOARD",
    .short_name = "G96-SUP",
    .have_pp = TRUE,
    .master_flag = TRUE,
    .service_flag = FALSE,
    .panel_portnum = 0,
    .subboard_fix_param = &g96sup_subboard_param,
    .ipp_fix_param = &g96sup_ipp_param,
    .temper_fix_param = &g96sup_temper_param,
    .os_upgrade = &g96sup_npd_os_upgrade,    
    .board_ready_config = &g96sup_board_ready_config,
    .feature = &g96sup_feature,
    .sdk_type = SDK_BCM,
    .board_support_product = (int*)g96sup_support_product
};
