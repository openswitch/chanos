...
long nh_3052_real_board_online(int slot_index)
{
    return nh_board_online(slot_index);
}

long nh3052_real_load_backinfo(product_man_param_t *param)
{
    npd_syslog_dbg("Get product sys info\n --%s", __FUNCTION__);
	
    param->basemac = (char*)base_mac;
    param->sn = "1001";
    param->name = "AuteU 3052";
...
void nh3052_real_npd_master_set(unsigned long value)
{
	return;
}

board_manage_fix_param_t nh3052_real_boardmn_fix_param =
{
    .slotnum = 1,
    .master_slotnum = 1,
    .master_slot_id = {0},
    ...
    .board_inserted = &nh_3052_real_board_online,
...
pne_fix_param_t nh3052_real_pne_fix_param = 
{
    .power_num = 1,
    .fan_num = 1,
    .pne_monitor_start = &nh_pne_monitor_start,
    .pne_fanspeed_adjust = &nh_fan_speed_adjust
};

product_feature_t nh3052_real_feature = 
{
    .jumbo_size = 13000,
    .max_macaddr = 16384,
    .max_macapp = 512,
...
product_fix_param_t nh3052_real_fix_param =
{
    .product_code = PPAL_PRODUCT_HWCODE_NH3052,
    .product_type = PRODUCT_NH_3052,
    .product_short_name = NH3052_SHORT_NAME,
    .product_name = "AuteU 3052 Multi-Layer Ethernet Switch",
    .product_pp_feature = &nh3052_real_feature,
    .serial_no = "1001",
    .board_manage = &nh3052_real_boardmn_fix_param,
    .pne_fix_param_t = &nh3052_real_pne_fix_param,
    .product_man_param_get = &nh3052_real_load_backinfo,
    .product_reset = &nh_sys_reset,
    .product_show_chassis = &nh_chassis_show,
    .slotno_get = &nh3052_real_slotno_get,
    .master_set = &nh3052_real_npd_master_set
};
