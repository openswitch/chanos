...
long tsm9024fc_npd_os_upgrade(unsigned int slot_index)
{
	return nh_os_upgrade(slot_index);
}

long tsm9024fc_board_ready_config(unsigned int slot_index)
{
	return chasm_board_ready_config(slot_index);
}

ipp_fix_param_t  tsm9024fc_ipp_param =
{
    .ipp_portnum = 2,
...
sub_board_fix_param_t tsm9024fc_subboard_param = 
{
    .sub_slotnum = 1,     // more than 1
    .sub_slot_portnum = 0
};

temper_fix_param_t tsm9024fc_temper_param =
{
    .num = 2,
    .name = {"OCTEON TEMP", "BCM 56320 TEMP"}
};

board_feature_t tsm9024fc_feature = 
{
    .jumbo_size = 13000,
    .max_macaddr = 32768,  
    .max_macapp = 512,
...
board_fix_param_t tsm9024fc_param =
{
    .board_code = PPAL_BOARD_HWCODE_TSM9024FC,
    .board_type = PPAL_BOARD_TYPE_TSM9024FC,
    .full_name = "AUTELAN AS9600 SERIES MULTI-LAYER SWITCH 12COMBO+12GESFP BOARD",
    .short_name = "ASG9624FC",
    .have_pp = TRUE,
    .master_flag = FALSE,
    .service_flag = FALSE,
    .panel_portnum = 24,
    .subboard_fix_param = &tsm9024fc_subboard_param,
    .ipp_fix_param = &tsm9024fc_ipp_param,
    .temper_fix_param = &tsm9024fc_temper_param,
    .os_upgrade = &tsm9024fc_npd_os_upgrade,
    .board_ready_config = &tsm9024fc_board_ready_config,
    .feature = &tsm9024fc_feature,
    .sdk_type = SDK_BCM,
    .board_support_product = (int*)tsm9024fc_support_product
};
