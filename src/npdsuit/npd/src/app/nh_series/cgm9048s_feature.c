...
long cgm9048s_sfp_online(unsigned long panel_port)
{
    return NPD_SUCCESS;
}

long cgm9048s_sfp_detect_start()
{
    return NPD_SUCCESS;    
}

long cgm9048s_sfp_info_get(unsigned long panel_port, fiber_module_man_param_t *param)
{
    return NPD_SUCCESS;
}

long cgm9048s_slotno_get()
{
	return nbm_slotno_get();
}

long cgm9048s_local_reset()
{
	return nbm_local_reset();
}

long cgm9048s_reset_type()
{
    npd_syslog_err("NH MCU reset type get not be supported.\n");
    return NPD_SUCCESS;
}

long cgm9048s_led_lighting(unsigned long status)
{
    npd_syslog_err("NH G96-48 led lighting not be supported.\n");
    return NPD_SUCCESS;
}

long cgm9048s_asic_led_proc(int unit)
{
    npd_syslog_dbg("NH G96-48S led code loading.\n");
	return 0;
}

long cgm9048s_pne_mon_start()
{
    npd_syslog_err("NH MCU p&e monitor not be supported.\n");
    return NPD_SUCCESS;
}

long cgm9048s_mnparam_get(board_man_param_t *info)
{
    info->id = PPAL_BOARD_HWCODE_CGM9048S;
	strncpy(info->sn, "1000", strlen("1000"));

	return t9000_board_mnparam_get(info);
}
extern void lcm_gchip_id_preconfig(int gchip_id);
void cgm9048s_sal_config_init_defaults(void)
{
    lcm_gchip_id_preconfig(UNIT_2_MODULE(SYS_LOCAL_MODULE_TYPE,
                                         SYS_LOCAL_MODULE_SLOT_INDEX, 0, 0));
   npd_syslog_dbg("cgm9048s_sal_config_init_defaults============\n");
   lcm_sdk_board_type_set(2);
}


long cgm9048s_local_conn_init(int product_type)
{
	int ret = 0;
	int i = 0;
...
long cgm9048s_system_conn_init(
    int product_type, 
...
long cgm9048s_system_conn_deinit(
    int product_type, 
    int del_board_type, 
    int del_slotid    
    )
...
long cgm9048s_system_master_switch(
    int product_type, 
...
fiber_module_fix_param_t cgm9048s_sfp_param =
{
    .fiber_module_inserted = &cgm9048s_sfp_online,
    .fiber_module_insert_detect = &cgm9048s_sfp_detect_start,
    .fiber_module_info_get = &cgm9048s_sfp_info_get,
};
long cgm9048s_nam_asic_enable()
{
	int ret = 0;
	int i = 0;
	unsigned char unit_no = 0;
...
ams_fix_param_t cgm9048s_asic_switch =
{
    ...
    .ams_led_proc = &cgm9048s_asic_led_proc,
};

board_spec_fix_param_t cgm9048s_spec_param =
{
    .board_type = PPAL_BOARD_TYPE_CGM9048S,

    .fiber_module_fix_param = &cgm9048s_sfp_param,
    .ams_param = {
                    [ASIC_SWITCH_TYPE] = &cgm9048s_asic_switch,
                 },
    .slotno_get = &cgm9048s_slotno_get,
    .reset = &cgm9048s_local_reset,
    .get_reset_type = &cgm9048s_reset_type,
    .sys_led_lighting = &cgm9048s_led_lighting,
    .pne_monitor_start = &cgm9048s_pne_mon_start,
    .board_man_param_get = &t9000_board_mnparam_get,
    .local_conn_init = &cgm9048s_local_conn_init,
    .system_conn_init = &cgm9048s_system_conn_init,
    .system_conn_deinit = &cgm9048s_system_conn_deinit,
    .asic_config_init = &cgm9048s_sal_config_init_defaults,
    .asic_after_data_sync_conf = &cgm9048s_nam_asic_enable,
    .master_switch = &cgm9048s_system_master_switch
};
