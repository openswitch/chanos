...
long ds6502_board_online(int slot_index)
{
    return TRUE;
}

long ds6502_load_backinfo(product_man_param_t *param)
{
...
void ds6502_npd_master_set(unsigned long value)
{
	return;
}

board_manage_fix_param_t ds6502_boardmn_fix_param =
{
    .slotnum = 2,
    .master_slotnum = 2,
    .master_slot_id = {0,1},
...
pne_fix_param_t ds6502_pne_fix_param = 
{
    .power_num = 2,
    .fan_num = 1,
...
product_feature_t ds6502_feature = 
{
    .jumbo_size = 16384,
    .max_macaddr = 65536,
    .max_macapp = 512,
...
product_fix_param_t ds6502_fix_param =
{
    ...
    .product_pp_feature = &ds6502_feature,
    .serial_no = "1001",
    .board_manage = &ds6502_boardmn_fix_param,
    .pne_fix_param_t = &ds6502_pne_fix_param,
    .product_man_param_get = &ds6502_load_backinfo,
    .product_reset = &ds_sys_reset,
    .product_show_chassis = &ds_chassis_show,
    .slotno_get = &ds6502_slotno_get,
    .master_set = &ds6502_npd_master_set
};
