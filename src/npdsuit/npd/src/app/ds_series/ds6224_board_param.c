...
long ds6224_board_npd_os_upgrade(unsigned int slot_index)
{
	npd_syslog_err("NH 3052 not be supported.\n");
	return NPD_SUCCESS;
}

ipp_fix_param_t  ds6224_board_ipp_param =
{
    .ipp_portnum = 1,
...
sub_board_fix_param_t ds6224_board_subboard_param = 
{
    .sub_slotnum = 1,     // more than 1
    .sub_slot_portnum = 0
};

temper_fix_param_t ds6224_board_temper_param =
{
    .num = 0,
};

board_feature_t ds6224_board_feature = 
{
    .jumbo_size = 16384,
    .max_macaddr = 65536,
    .max_macapp = 512,
...
board_fix_param_t ds6224_board_param =
{
    .board_code = PPAL_BOARD_HWCODE_DS6224,
    .board_type = PPAL_BOARD_TYPE_DS6224,
    .full_name  = "CHANOS Multi-Layer Datacenter Switch with 24X10GE",
    .short_name = "DS6224",
    .have_pp = TRUE,
    .master_flag = FALSE,
    .service_flag = TRUE,
    .panel_portnum = 24,
    .subboard_fix_param = &ds6224_board_subboard_param,
    .ipp_fix_param = &ds6224_board_ipp_param,
    .temper_fix_param = &ds6224_board_temper_param,
    .os_upgrade = &ds6224_board_npd_os_upgrade,
    .feature = &ds6224_board_feature,
    .sdk_type = SDK_MARVELL,
    .board_support_product = (int *)ds6224_board_support_product,
